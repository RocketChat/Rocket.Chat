import type { IBusinessHourWorkHour, ILivechatBusinessHour, ILivechatCustomField, ILivechatInquiryRecord, ILivechatTrigger, IOmnichannelCannedResponse, IOmnichannelSystemMessage, SettingValue } from "@rocket.chat/core-typings";
