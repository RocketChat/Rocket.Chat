...
export type MessageQuoteAttachment = {
	...
	text: string;
	md?: Root;
	attachments?: Array<MessageAttachment>; // TODO this is cauising issues to define a model, see @ts-expect-error at apps/meteor/app/api/server/v1/channels.ts:274
