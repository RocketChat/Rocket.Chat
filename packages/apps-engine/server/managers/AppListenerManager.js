...
class AppListenerManager {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (int) {
                ...
                case metadata_1.AppInterface.IPostMessageSent:
                    ...
                    return;
                case metadata_1.AppInterface.IPostSystemMessageSent:
                    this.executePostSystemMessageSent(data);
                    return;
    ...
    executePostSystemMessageSent(data) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const appId of this.listeners.get(metadata_1.AppInterface.IPostSystemMessageSent)) {
                const app = this.manager.getOneById(appId);
                yield app.call(metadata_1.AppMethod.EXECUTEPOSTSYSTEMMESSAGESENT, data);
            }
        });
    }
