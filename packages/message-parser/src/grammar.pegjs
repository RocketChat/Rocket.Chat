 ...
 */
AutolinkedURL
  = s:openPunctuation u:AutolinkedURL_urlDelimitedByPunctuation e:closePunctuation { return [plain(s), autoLink(u, options.customDomains), plain(e)]; }
  / u:AutolinkedURL_url { return autoLink(u, options.customDomains); }

AutolinkedURL_urlDelimitedByPunctuation
  = $(URLScheme URLAuthority (!closePunctuation .)*)
  / $(URLAuthorityHost (!closePunctuation .)*)
