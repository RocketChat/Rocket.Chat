...
> quote here`,
	...
	['[link](https://example.com/query?this=(is)&a=problem)', [paragraph([link('https://example.com/query?this=(is)&a=problem', [plain('link')])])]],
	['[Wikipedia](https://en.wikipedia.org/wiki/Bracket_(disambiguation))', [paragraph([link('https://en.wikipedia.org/wiki/Bracket_(disambiguation)', [plain('Wikipedia')])])]],
	[
	...
	['[URL with trailing paren](https://example.com/page(version))', [paragraph([link('https://example.com/page(version)', [plain('URL with trailing paren')])])]],
	[
	...
	['[Parens with slash](https://example.com/(api)/v1/users)', [paragraph([link('https://example.com/(api)/v1/users', [plain('Parens with slash')])])]],
	['[Deep nesting](https://example.com/path/((nested(deep)))/end)', [paragraph([link('https://example.com/path/((nested(deep)))/end', [plain('Deep nesting')])])]],
	['[URL ending with multiple parens](https://example.com/func(arg1)(arg2))', [paragraph([link('https://example.com/func(arg1)(arg2)', [plain('URL ending with multiple parens')])])]],
	['[Parentheses in fragment](https://example.com/page#section(1))', [paragraph([link('https://example.com/page#section(1)', [plain('Parentheses in fragment')])])]],
	['[Math expression](https://example.com/calc?expr=(2+3)*(4+5))', [paragraph([link('https://example.com/calc?expr=(2+3)*(4+5)', [plain('Math expression')])])]],
