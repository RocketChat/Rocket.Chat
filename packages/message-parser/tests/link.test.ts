...
> quote here`,
  ...
  [
    ...
    [
      paragraph([
        link('https://en.wikipedia.org/wiki/Bracket_(disambiguation)', [
          plain('Wikipedia'),
        ]),
      ]),
    ],
  ...
  [
    ...
    [
      paragraph([
        link('https://example.com/path/(foo(bar))/file.html', [
          plain('Nested (parentheses) in URL'),
        ]),
      ]),
    ],
  ],
  ...
  [
    ...
    [
      paragraph([
        link('https://example.com/page(version)', [
          plain('URL with trailing paren'),
        ]),
      ]),
    ],
  ],
  [
    ...
    [
      paragraph([
        plain('Check out '),
        link('https://grafana.io/dashboard?var=(node_mem)', [
          plain('this link'),
        ]),
        plain(' for metrics'),
      ]),
  ...
  [
    ...
    [
      paragraph([
        link('https://example.com/(api)/v1/users', [
          plain('Parens with slash'),
        ]),
      ]),
    ],
  ],
  [
    ...
    [
      paragraph([
        link('https://example.com/path/((nested(deep)))/end', [
          plain('Deep nesting'),
        ]),
      ]),
    ],
...
`.trim(),
  ...
  [
    ...
    [
      paragraph([
        link('https://example.com/func(arg1)(arg2)', [
          plain('URL ending with multiple parens'),
        ]),
      ]),
    ],
  ],
  [
    ...
    [
      paragraph([
        link('https://example.com/page#section(1)', [
          plain('Parentheses in fragment'),
        ]),
      ]),
    ],
  ],
  [
    ...
    [
      paragraph([
        link('https://example.com/calc?expr=(2+3)*(4+5)', [
          plain('Math expression'),
        ]),
      ]),
    ],
  ],
