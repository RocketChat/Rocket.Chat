...
test.each([
	...
	['https://localhost:3000?', [paragraph([link('https://localhost:3000?')])]],
	['https://localhost:3000/', [paragraph([link('https://localhost:3000/')])]],
	['localhost', [paragraph([plain('localhost')])]],
	['just testing localhost here', [paragraph([plain('just testing localhost here')])]],
	['rocket.chat', [paragraph([link('//rocket.chat', [plain('rocket.chat')])])]],
