...
Template.messagePopup.onCreated(function() {
	...
	template.up = () => {
		...
		if (previous != null) {
			current.className = current.className.replace(/\sselected/, '').replace('sidebar-category-badge-background', '');
			previous.className += ' selected sidebar-category-badge-background';
	...
	template.down = () => {
		...
		if (next && next.classList.contains('popup-item')) {
			current.className = current.className.replace(/\sselected/, '').replace('sidebar-category-badge-background', '');
			next.className += ' selected sidebar-category-badge-background';
	...
	template.verifySelection = () => {
		...
		if (current == null) {
			...
			if (first != null) {
				first.className += ' selected sidebar-category-badge-background';
...
Template.messagePopup.events({
	'mouseenter .popup-item'(e) {
		...
		e.currentTarget.className += ' selected sidebar-category-badge-background';
