...
// over the page size so permission filtering has spare candidates to drop
export const MAX_INTELLIGENT_SEARCH_CANDIDATES = MAX_INTELLIGENT_SEARCH_RESULTS * 2;
export const CLASSIFICATION_SEARCH_TYPE = 2;
