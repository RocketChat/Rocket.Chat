...
export class SmartiProxy {
	...
	static get googleSearchUrl() {
		return RocketChat.settings.get('Assistify_AI_Google_CS_URL');
	}
	static get googleSearchKey() {
		return RocketChat.settings.get('Assistify_AI_Google_CS_KEY');
	}
	static get googleSearchId() {
		return RocketChat.settings.get('Assistify_AI_Google_CS_ID');
	}
