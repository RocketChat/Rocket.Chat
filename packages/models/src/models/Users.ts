...
export class UsersRaw extends BaseRaw<IUser, DefaultFields<IUser>> implements IUsersModel {
	...
	async checkOnlineAgents(agentId: IUser['_id']) {
		// TODO:: Create class Agent
	...
	findOnlineAgents<T extends Document = ILivechatAgent>(agentId?: IUser['_id']) {
		// TODO:: Create class Agent
		const query = queryStatusAgentOnline(agentId && { _id: agentId });
	...
	// 2
	async getNextAgent(ignoreAgentId?: string, extraQuery?: Filter<IUser>) {
		// TODO: Create class Agent
