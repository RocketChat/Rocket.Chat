...
import type { Collection, IndexDescription, FindOptions, FindCursor, Document } from 'mongodb';

import { BaseRaw } from './BaseRaw';

export class LivechatCustomFieldRaw extends BaseRaw<ILivechatCustomField> implements ILivechatCustomFieldModel {
	constructor(trash?: Collection<RocketChatRecordDeleted<ILivechatCustomField>>) {
		super('livechat_custom_field', trash);
	}
