...
if (!dbWatchersDisabled) {
	console.warn(
		`Database watchers are enabled this is not the default option.\nWe deprecate the usage of \`oplog/change streams\` and we are going to remove it the next major version (8.0.0).`,
	);
}
