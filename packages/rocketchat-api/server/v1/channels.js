...
RocketChat.API.v1.addRoute('channels.setEncrypted', { authRequired: true }, {
        post() {
                ...
                if (findResult.encrypted === this.bodyParams.encrypted) {
                        return RocketChat.API.v1.failure('The channel encrypted is the same as what it would be changed to.');
                }
