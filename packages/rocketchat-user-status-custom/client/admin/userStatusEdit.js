...
Template.userStatusEdit.helpers({
  ...
  options() {
    return [{
      "value": "online",
      "name": t("Online"),
      "selected": this.userStatus.statusType == 'online' ? 'selected' : ''
    },{
      "value": "away",
      "name": t("Away"),
      "selected": this.userStatus.statusType == 'away' ? 'selected' : ''
    },{
      "value" : "busy",
      "name": t("Busy"),
      "selected": this.userStatus.statusType == 'busy' ? 'selected' : ''
    },{
      "value": "offline",
      "name": t("Invisible"),
      "selected": this.userStatus.statusType == 'offline' ? 'selected' : ''
    }];
  }
});
