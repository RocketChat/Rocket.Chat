...
import { getAllRoutes, registerAllElysiaRoutes } from './controllers';
...
// Export for use in both modes
export const homeserverModule = new HomeserverModule();

// Export app promise for backward compatibility
export const appPromise = homeserverModule.createApp();

// Export route handlers for monolith mode
