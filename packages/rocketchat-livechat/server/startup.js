Meteor.startup(() => {
	RocketChat.roomTypes.setRoomFind('l', (code) => {
		...
		return RocketChat.cache.Rooms.findByIndex('t,code', ['l', code]).fetch();
	...
	// 	console.log('addRoomAccessValidator ->', RocketChat.authz.hasPermission(user._id, 'view-livechat-rooms'), room, user);
