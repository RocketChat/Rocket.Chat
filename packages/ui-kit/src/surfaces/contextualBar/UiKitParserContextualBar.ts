...
type ContextualBarSurfaceLayoutBlock = ActionsBlock | ContextBlock | DividerBlock | HeaderBlock | ImageBlock | InputBlock | SectionBlock;
...
export abstract class UiKitParserContextualBar<OutputElement> extends SurfaceRenderer<OutputElement, ContextualBarSurfaceLayoutBlock> {
	public constructor() {
		super(['actions', 'context', 'divider', 'header', 'image', 'input', 'section']);
	}
}
