...
export type EditableSettingsContextValue = {
  readonly queryEditableSetting: (
    _id: SettingId
  ) => Subscription<IEditableSetting | undefined>;
...
export const EditableSettingsContext =
  createContext<EditableSettingsContextValue>({
...
export const useEditableSetting = (
  _id: SettingId
): IEditableSetting | undefined => {
...
export const useEditableSettingsGroupSections = (
  _id: SettingId,
  tab?: TabId
): SectionName[] => {
...
export const useEditableSettingsDispatch = (): ((
  changes: Partial<IEditableSetting>[]
) => void) => useContext(EditableSettingsContext).dispatch;
