...
Template.integrationsIncomingHistory.onCreated(function _integrationsIncomingHistoryOnCreated() {
...
Template.integrationsIncomingHistory.helpers({
	hasPermission() {
	...
	eventTypei18n(event) {
		return TAPi18n.__(RocketChat.integrations.incomingEvents[event].label);
	},
...
Template.integrationsIncomingHistory.events({
	'click .expand': (e) => {
