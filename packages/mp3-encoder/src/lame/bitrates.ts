...
const getBitrates = (version: 0 | 1, samplerate = LOW_SAMPLE_RATE_THRESHOLD) => {
	if (samplerate < 16000) {
...
export function findNearestBitrate(bRate: number, version: 0 | 1, samplerate: number): Bitrate {
...
export function findBitrateIndex(bRate: number, version: 0 | 1, samplerate: number): BitrateIndex {
	const bitrates = getBitrates(version, samplerate);
