...
export class Encoder {
	...
	private lame_encode_frame_init(gfp: LameGlobalFlags, inbuf: [Float32Array, Float32Array]) {
	...
	lame_encode_mp3_frame(
		...
		const masking_LR = Array.from({ length: 2 }, () => Array.from({ length: 2 }, () => new III_psy_ratio()));
