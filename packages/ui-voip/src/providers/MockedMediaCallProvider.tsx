...
const myData: { value: string; label: string; identifier: string; avatarUrl: string }[] = Array.from({ length: 100 }, (_, i) => ({
	value: `user-${i}`,
	label: `User ${i}`,
	identifier: `000${i}`,
	avatarUrl,
...
const MockedMediaCallProvider = ({
	...
	const onToggleScreenShare = async () => undefined;
