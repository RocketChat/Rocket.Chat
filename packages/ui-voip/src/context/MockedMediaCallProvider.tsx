...
const MockedMediaCallProvider = ({
	...
	return (
		<MediaCallInstanceContext.Provider value={instanceContextValue}>
			<MediaCallWidgetContext.Provider value={contextValue}>{children}</MediaCallWidgetContext.Provider>
