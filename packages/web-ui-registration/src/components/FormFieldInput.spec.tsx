...
describe('FormFieldInput', () => {
	it('should render text input with label', () => {
		render(<FormFieldInput label='Test Field' fieldId='test-id' register={mockRegister} />, { wrapper: defaultAppRoot });
	...
	it('should render textarea when type is textarea', () => {
		render(<FormFieldInput label='Test Field' fieldId='test-id' register={mockRegister} type='textarea' />, { wrapper: defaultAppRoot });
	...
	it('should mark field as required', () => {
		render(<FormFieldInput label='Test Field' fieldId='test-id' required register={mockRegister} />, { wrapper: defaultAppRoot });
	...
	it('should display error message', () => {
		...
		render(<FormFieldInput label='Test Field' fieldId='test-id' error={error as any} register={mockRegister} />, {
	...
	it('should apply placeholder', () => {
		render(<FormFieldInput label='Test Field' fieldId='test-id' placeholder='Enter text' register={mockRegister} />, {
			wrapper: defaultAppRoot,
		});
