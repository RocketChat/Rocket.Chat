...
describe('RegisterForm', () => {
	...
	describe('Conditional Fields', () => {
		...
		it('should NOT render reason field when manual approval is not required', () => {
			const appRoot = mockAppRoot().withSetting('Accounts_ManuallyApproveNewUsers', false).build();
	...
	describe('Custom Fields Integration', () => {
		it('should render custom fields when available', () => {
			...
			const mockCustomFields = [{ _id: 'field1', type: 'text', label: 'Custom Field 1', required: true, defaultValue: '', public: true }];
