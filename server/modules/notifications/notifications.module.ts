...
export class NotificationsModule {
	...
	public readonly streamAdmin: IStreamer;
	...
	constructor(
		...
		this.streamAdmin = new this.Streamer('notify-admin');
	...
	notifyAdmin(userId: string, eventName: string, ...args: any[]): void {
		if (this.debug === true) {
			console.log('notifyAdmin', [userId, eventName, ...args]);
		}
		return this.streamAdmin.emit(eventName, ...args);
	}
