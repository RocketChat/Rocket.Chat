...
export default [
	...rocketChatConfig,
	{
		ignores: [
			...
			'apps/meteor/**/imports',
			'apps/meteor/packages/apps',
			'apps/meteor/packages/autoupdate',
			'apps/meteor/packages/linkedin-oauth',
			'apps/meteor/packages/meteor-cookies',
			'apps/meteor/packages/meteor-inject-initial',
			'apps/meteor/packages/meteor-run-as-user',
			'apps/meteor/packages/rocketchat-coverage',
			'apps/meteor/packages/rocketchat-i18n',
			'apps/meteor/packages/rocketchat-livechat',
			'apps/meteor/packages/rocketchat-mongo-config',
			'apps/meteor/packages/rocketchat-postcss',
			'apps/meteor/packages/rocketchat-version',
			'apps/meteor/.meteor/**',
		],
	},
	{
