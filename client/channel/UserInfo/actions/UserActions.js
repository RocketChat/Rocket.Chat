...
const UserActions = ({ user, rid }) => {
	...
	const menu = menuOptions && <Menu small={false} mi='x4' ghost={false} renderItem={({ label: { label, icon }, ...props }) => <Option {...props} label={label} icon={icon} />} flexShrink={0} key='menu' options={menuOptions} />;
