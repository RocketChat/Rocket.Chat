...
type ServerContextValue = {
	...
	callEndpoint: (httpMethod: 'GET' | 'POST' | 'PUT' | 'DELETE', endpoint: string, ...args: any[]) => Promise<any>;
...
export const useEndpoint = (httpMethod: 'GET' | 'POST' | 'PUT' | 'DELETE', endpoint: string): (...args: any[]) => Promise<any> => {
