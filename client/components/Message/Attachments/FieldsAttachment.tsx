...
const Field: FC<BoxProps | FieldProp> = ({ title, value, ...props }) => (
...
const ShortField: FC<FieldProp> = (props) => (
	<Field {...props} flexGrow={1} width='50%' flexBasis={1} />
);

export type FieldsAttachmentProps = Array<FieldProp>;

export const FieldsAttachment: FC<{ fields: FieldsAttachmentProps }> = ({ fields }): any => (
