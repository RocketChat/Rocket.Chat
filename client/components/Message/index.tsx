...
export const Content: FC<BoxProps> = (props) => (
	<Box display='flex' mb='x4' mi='neg-x4' {...props} />
);
...
const MetricsItem: FC<BoxProps> & { Icon: FC<IconProps>; Label: FC<BoxProps> } = (props) => (
	<Box
		display='flex'
...
const MetricsFollowing: FC<FollowingProps> = ({ name }) => (
	<ActionButton color='info' small ghost icon={name} />
);
