...
export function Setting({ settingId, sectionChanged }) {
	...
	const hasResetButton = !disableReset && !readonly && type !== 'asset' && (JSON.stringify(contextEditor) !== JSON.stringify(editor) || JSON.stringify(value) !== JSON.stringify(packageValue)) && !disabled;
