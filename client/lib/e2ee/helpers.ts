...
export const joinVectorAndEncryptedData = (
	vector: Uint8Array,
...
export const splitVectorAndEncryptedData = (
	cipherText: Uint8Array,
): [vector: Uint8Array, encryptedData: Uint8Array] => {
...
): Promise<ArrayBuffer> => crypto.subtle.encrypt({ name: 'AES-CBC', iv: vector }, key, data);
...
export const decryptAES = (
	...
	key: CryptoKey,
	data: Uint8Array | ArrayBuffer,
): Promise<ArrayBuffer> => crypto.subtle.decrypt({ name: 'AES-CBC', iv: vector }, key, data);
