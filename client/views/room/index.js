...
import { useUserPreference, useUserSubscription } from '../../contexts/UserContext';
...
const Room = () => {
	...
	return <RoomTemplate aria-label={t('Channel')} data-qa-rc-room={room._id}>
		<RoomTemplate.Header><Header room={room} rid={room._id} subscription={subscription}/></RoomTemplate.Header>
