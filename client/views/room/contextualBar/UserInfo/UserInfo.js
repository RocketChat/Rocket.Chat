...
function UserInfo({
	...
	const canViewLastLogin = hasPermission('view-full-other-user-info_last_login');
	const canViewCreatedAt = hasPermission('view-full-other-user-info_created_at');
	...
	return (
		<VerticalBar.ScrollableContent p='x24' {...props}>
			<InfoPanel>
				...
				<InfoPanel.Section>
					<InfoPanel.Title title={name || username} icon={status} />
				...
				<InfoPanel.Section>
					...
					{canViewAllInfo && canViewLastLogin && (
						<InfoPanel.Field>
