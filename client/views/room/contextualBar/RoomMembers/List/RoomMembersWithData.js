...
const RoomMembersWithData = ({ rid }) => {
	...
	const [type, setType] = useLocalStorage('members-list-type', 'all');
	...
	const canCreateInvitelink = usePermission('create-invite-links', room._id);
	...
	return (
		<RoomMembers
			...
			onClickInvite={canCreateInvitelink && canAddUsers && createInvite}
