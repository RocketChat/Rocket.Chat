...
import UnreadCounterPreference from './components/UnreadCounterPreference';
	...
	return (
		<>
			...
			<VerticalBar.ScrollableContent>
				...
				/>
				<UnreadCounterPreference
					label={t('Unread')}
					description={t('Unread_Count')}
					icon={'thread'}
					options={handleOptions.unreadCounter}
					optionDefault={formValues?.unreadCounter}
					onChange={formHandlers?.handleUnreadCounter}
				/>
				<FieldGroup>
