...
Talk with Rocket.Chat's leadership at the [Community Open Call](https://www.youtube.com/watch?v=LImlxcaEYvE), held monthly.  Join us for [the next Community Open Call](https://app.livestorm.co/rocket-chat/community-open-call?type=detailed).
...
Any other questions, reach out to us at [contact@rocket.chat](https://rocket.chat/contact). We’d happy to help!
