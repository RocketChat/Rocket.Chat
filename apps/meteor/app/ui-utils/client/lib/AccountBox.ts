import type { IUIActionButtonDescriptorDefault } from '@rocket.chat/apps-engine/definition/ui/IUIActionButtonDescriptor';
...
export interface IAppAccountBoxItem extends IUIActionButtonDescriptorDefault<'accountBoxItem'> {
	name: string;
	icon?: string;
	href?: string;
	sideNav?: string;
