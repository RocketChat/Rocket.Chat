...
MessageTypes.registerType({
	...
	data(message: IOmnichannelSystemMessage): { history?: string } {
...
MessageTypes.registerType({
	...
	data(message: IOmnichannelSystemMessage): { transfer?: string } {
...
MessageTypes.registerType({
	...
	data(message: IOmnichannelSystemMessage): { transcript?: string } {
...
MessageTypes.registerType({
	...
	data(message: IOmnichannelSystemMessage): { comment?: string } {
		return {
