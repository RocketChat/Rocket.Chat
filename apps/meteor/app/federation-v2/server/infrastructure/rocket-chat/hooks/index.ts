...
export class FederationHooks {
	public static afterLeaveRoom(callback: (user: IUser, room: IRoom) => Promise<void>): void {
		callbacks.add(
			'afterLeaveRoom',
	...
	public static afterRemoveFromRoom(callback: (removedUser: IUser, room: IRoom, userWhoRemoved: IUser) => Promise<void>): void {
		callbacks.add(
			'afterRemoveFromRoom',
	...
	public static canAddTheUserToTheRoom(callback: (user: IUser | string, room: IRoom) => Promise<void>): void {
		callbacks.add(
	...
	public static canAddUsersToTheRoom(callback: (user: IUser | string, inviter: IUser, room: IRoom) => Promise<void>): void {
		callbacks.add(
			'federation.beforeAddUserAToRoom',
	...
	public static beforeCreateDirectMessage(callback: (members: IUser[]) => Promise<void>): void {
		callbacks.add(
