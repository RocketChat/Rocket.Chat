			...
			response: {
				200: ajv.compile({
						...
						videoConf: {
							...
							properties: {
								...
								settings: {
									...
									required: ['provider', 'dms', 'channels', 'groups', 'teams'],
									// additionalProperties: false,
								},
							},
					...
					required: [
						...
						// 'roomsInsideTeams', FIXME: this should be on becouse its not optional in the parant interface [IStats](https://github.com/ahmed-n-abdeltwab/Rocket.Chat/blob/feat/OpenAPI/packages/core-typings/dist/IStats.d.ts)
						'showHomeButton',
