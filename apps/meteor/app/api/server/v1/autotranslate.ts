...
type AutotranslateGetSupportedLanguagesParamsGET = {
...
const isAutotranslateGetSupportedLanguagesParamsGET = ajv.compile<AutotranslateGetSupportedLanguagesParamsGET>(
	AutotranslateGetSupportedLanguagesParamsGETSchema,
);

type AutotranslateSaveSettingsParamsPOST = {
	roomId: string;
...
const isAutotranslateSaveSettingsParamsPOST = ajv.compile<AutotranslateSaveSettingsParamsPOST>(
