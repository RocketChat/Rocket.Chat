import type { IOutgoingIntegration, IIntegration, IIntegrationHistory } from '@rocket.chat/core-typings';
...
declare module '@rocket.chat/ddp-client' {
	...
	interface ServerMethods {
		replayOutgoingIntegration(params: { integrationId: IIntegration['_id']; historyId: IIntegrationHistory['_id'] }): Promise<boolean>;
	}
}
