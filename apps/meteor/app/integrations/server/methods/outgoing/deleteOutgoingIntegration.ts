...
declare module '@rocket.chat/ddp-client' {
	...
	interface ServerMethods {
		deleteOutgoingIntegration(integrationId: IIntegration['_id']): Promise<boolean>;
	}
}

export const deleteOutgoingIntegration = async (integrationId: IIntegration['_id'], userId: string): Promise<void> => {
	let integration;
