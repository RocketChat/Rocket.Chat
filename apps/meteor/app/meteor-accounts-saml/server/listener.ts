...
const middleware = async function (req: Request, res: ServerResponse, next: (err?: any) => void): Promise<void> {
...
WebApp.connectHandlers.use(/^\/_saml/, bodyParser.json(), async (req: IncomingMessage, res: ServerResponse, next: (err?: any) => void) =>
