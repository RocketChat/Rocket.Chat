		...
		>
			...
			<MessageSystemContainer>
				<MessageSystemBlock>
					...
					{messageType && <MessageSystemBody data-qa-type='system-message-body' style={{ whiteSpace: 'normal', wordWrap: 'break-word' }}>{messageType.text(t, message)}</MessageSystemBody>}
