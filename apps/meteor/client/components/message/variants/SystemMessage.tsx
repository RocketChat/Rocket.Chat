		...
		>
			...
			<MessageSystemContainer>
				<MessageSystemBlock>
					...
					{messageType && <MessageSystemBody data-qa-type='system-message-body' style={{ whiteSpace: 'normal', overflowWrap: 'anywhere' }}>{messageType.text(t, message)}</MessageSystemBody>}
