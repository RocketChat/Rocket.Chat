...
describe('RecipientForm', () => {
	...
	it('renders correctly with all required fields', async () => {
		...
		await waitFor(() => expect(screen.getByLabelText('Contact*')).toHaveAttribute('aria-busy', 'false'));
	...
	it('should render with default values', async () => {
		...
		await waitFor(() => expect(screen.getByLabelText('Contact*')).toHaveAttribute('aria-busy', 'false'));
		expect(screen.getByLabelText('Contact*')).toHaveTextContent('Contact 1');
		expect(screen.getByLabelText('Channel*')).toHaveTextContent('Provider 1');
	...
	it('should disable recipient selection when no provider is selected', async () => {
		...
		await waitFor(() => expect(screen.getByLabelText('Channel*')).toHaveAttribute('aria-busy', 'false'));
