	...
	return (
		<UserCardDialog {...props}>
			<Box display='flex' alignItems='center'>
				...
				<Box display='flex' flexDirection='column' flexGrow={1} flexShrink={1} marginInlineStart={4}>
					<Skeleton width='50%' />
					<Skeleton width='75%' />
				</Box>
			</Box>
			...
			<Box display='flex' marginBlockStart={24}>
				<Skeleton variant='rect' height='x32' flexGrow={1} borderRadius='x4' marginInlineEnd={8} />
				<Skeleton variant='rect' height='x32' flexGrow={1} borderRadius='x4' marginInlineEnd={8} />
