...
// import { useSideBarRoomList } from '../hooks/useRoomList';
...
const RoomList = () => {
	...
	// const { groupsCount, groupsList, roomList, groupedUnreadInfo } = useSideBarRoomList();
	const { groupsCount, groupsList, roomList, groupedUnreadInfo, collapsedGroups, handleClick, handleKeyDown } = useSideBarRoomsList();
