...
interface IDeleteScheduledMessageModalProps {
...
const DeleteScheduledMessageModal = ({ message, onConfirm, onClose, formatScheduledTime }: IDeleteScheduledMessageModalProps) => {
	...
	const handleConfirm = async () => {
		...
		try {
			...
			dispatchToastMessage({
				type: 'error',
				message: error instanceof Error ? error.message : t('Failed_to_cancel_scheduled_message'),
			});
		} finally {
	...
	return (
		...
		>
			...
			<Box marginBlockStart='x16'>
				<Box p='x12' bg='neutral-800' borderRadius='x4' fontStyle='italic' color='neutral-300' mbe='x4'>
