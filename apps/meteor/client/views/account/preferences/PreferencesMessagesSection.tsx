		...
		<AccordionItem title={t('Messages')}>
			<FieldGroup>
				...
				<Field>
					...
					<FieldLink aria-describedby={messageTimeFormatLabelId} href={`/account/accessibility-and-appearance#${TARGET_ANCHORS.clockMode}`}>
				...
				<Field>
					...
					<FieldLink aria-describedby={hideUsernamesLabelId} href={`/account/accessibility-and-appearance#${TARGET_ANCHORS.hideUsernames}`}>
						{t('Go_to_accessibility_and_appearance')}
					</FieldLink>
				</Field>
				<Field>
					<FieldLabel id={hideRolesLabelId}>{t('Hide_roles')}</FieldLabel>
					<FieldLink aria-describedby={hideRolesLabelId} href={`/account/accessibility-and-appearance#${TARGET_ANCHORS.hideRoles}`}>
						{t('Go_to_accessibility_and_appearance')}
					</FieldLink>
				</Field>
				<Field>
