...
const PreferencesSoundSection = () => {
	...
	return (
		<AccordionItem title={t('Sound')}>
			<Field>
				<FieldLabel required>{t('Master_volume')}</FieldLabel>
			...
			<Field>
				<FieldLabel required>{t('Notification_volume')}</FieldLabel>
			...
			<Field>
				<FieldLabel required>{t('Call_ringer_volume')}</FieldLabel>
			...
			<Field>
				<FieldLabel required>{t('New_Room_Notification')}</FieldLabel>
				<FieldRow>
					<Controller
			...
			<Field>
				<FieldLabel required>{t('New_Message_Notification')}</FieldLabel>
				<FieldRow>
					<Controller
			...
			<Field>
				<FieldRow>
					<FieldLabel required>{t('Mute_Focused_Conversations')}</FieldLabel>
					<Controller
