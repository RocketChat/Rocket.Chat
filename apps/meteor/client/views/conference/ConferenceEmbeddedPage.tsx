...
const ConferenceEmbeddedPage = ({ callId }: ConferenceEmbeddedPageProps) => {
	...
	// in a modal instead — opened through the conference's own modal region, which `ConferenceViewport` mounts,
	// so it renders inside this page's providers rather than at the app root, where the room it loads has none.
