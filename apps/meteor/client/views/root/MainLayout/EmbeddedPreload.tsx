...
export type EmbeddedPreloadProps = { children: ReactNode; reference?: string; type?: RoomType; rid?: IRoom['_id'] };

const EmbeddedPreload = ({ children, reference, type, rid }: EmbeddedPreloadProps) => {
