	...
	return (
		<Table.Row action>
			<Table.Cell maxWidth='x300' withTruncatedText>
				<CheckBox checked={selected} onChange={handleChange} disabled={lastOwnerWarning && isLastOwner} />
				<Margins inline='x8'>
					<Icon size='x16' {...useRoomIcon(room)} />
					{fname ?? name}
					{lastOwnerWarning && isLastOwner && <Icon size='x16' name='info-circled' color='danger' title={lastOwnerWarning} />}
				</Margins>
			</Table.Cell>
