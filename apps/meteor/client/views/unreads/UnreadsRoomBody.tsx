import { IMessage, IRoom, isEditedMessage, isOmnichannelRoom, ISubscription, IUser } from '@rocket.chat/core-typings';
import {
	useCurrentRoute,
	usePermission,
...
import Announcement from '../room/Announcement';
// import LegacyMessageTemplateList from '../room/LegacyMessageTemplateList';
// import LoadingMessagesIndicator from '../room/LoadingMessagesIndicator';
...
// import NewMessagesButton from '../room/NewMessagesButton';
// import RetentionPolicyWarning from '../room/RetentionPolicyWarning';
// import RoomForeword from '../room/RoomForeword';
// import UnreadMessagesIndicator from '../room/UnreadMessagesIndicator';
// import UploadProgressIndicator from '../room/UploadProgressIndicator';
// import ComposerContainer from '../room/composer/ComposerContainer';
import DropTargetOverlay from '../room/components/body/DropTargetOverlay';
import JumpToRecentMessagesBar from '../room/components/body/JumpToRecentMessagesBar';
// import LeaderBar from '../room/components/body/LeaderBar';
import LeaderBar from '../room/components/body/LeaderBar';
...
import NewMessagesButton from '../room/components/body/NewMessagesButton';
...
import UploadProgressIndicator from '../room/components/body/UploadProgressIndicator';
import { useChatMessages } from '../room/components/body/useChatMessages';
import { useFileUploadDropTarget } from '../room/components/body/useFileUploadDropTarget';
import { useRetentionPolicy } from '../room/components/body/useRetentionPolicy';
import { useUnreadMessages } from '../room/components/body/useUnreadMessages';
import { useRoomSubscription, useRoomMessages } from '../room/contexts/RoomContext';
import { useToolboxContext } from '../room/contexts/ToolboxContext';

interface IUnreadsRoomBodyProps {
	room: ISubscription & IRoom;
}

const UnreadsRoomBody = ({ room }: IUnreadsRoomBodyProps): ReactElement => {
...
export default memo(UnreadsRoomBody);
