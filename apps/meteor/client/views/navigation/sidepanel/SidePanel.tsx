...
import { useIsRoomFilterEnabled, type AllGroupsKeys } from '../contexts/RoomsNavigationContext';
...
const SidePanel = ({ title, currentTab, unreadOnly, toggleOnlyUnreads, rooms }: SidePanelProps) => {
	...
	const isRoomFilterEnabled = useIsRoomFilterEnabled();
			...
			<Box pb={8} h='full' ref={ref}>
				...
				<VirtualizedScrollbars>
					<Virtuoso
						...
						itemContent={(_, data) => <RoomSidepanelItem openedRoom={openedRoom} room={data} isRoomFilter={isRoomFilterEnabled} />}
					/>
				</VirtualizedScrollbars>
			</Box>
		</Sidepanel>
