...
const UserCardWithData = ({ username, target, open, onClose }: UserCardWithDataProps): ReactElement => {
	...
	const userActions = useUserInfoActions({ _id: user._id ?? '', username: user.username });
