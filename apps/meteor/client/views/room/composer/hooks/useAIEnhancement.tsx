...
export const useAIEnhancement = (contentRef: RefObject<HTMLDivElement>): ReactElement | null => {
	...
	// TODO: fix the position to be on the start of the selected text
		...
		<Box className={popupPosition} onMouseDown={(e) => e.preventDefault()}>
			<MessageToolbarWrapper visible={true}>
				<MessageToolbar ref={toolbarRef} {...toolbarProps}>
					{/* TODO: replace icons with 'text-star', 'emoji-star', 'language-star' when available in fuselage icons */}
					<MessageToolbarItem id='ai-enhancement-summary' onClick={() => runAIAction('summary')} icon='burger-menu' title='AI summarize' />
