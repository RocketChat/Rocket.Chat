...
export const useAudioMessageAction = (isMicrophoneDenied: boolean | undefined) => {
	...
	return { handleRecordButtonClick, audioTitle: getMediaActionTitle, isAudioAllowed: isAllowed };
};
