...
import type { MapProviderName, IMapProvider } from './mapProvider';
...
const MapView: React.FC<MapViewProps> = ({
	...
	const staticUrl = mapInstance?.getStaticMapUrl(latitude, longitude, { zoom, width, height }) ?? null;
	...
	if (staticUrl) {
		return (
			<div style={{ display: 'inline-block' }}>
				...
				>
					<img src={staticUrl} alt='Map preview' style={{ display: 'block', width: '100%', height: 'auto' }} />
				</div>
