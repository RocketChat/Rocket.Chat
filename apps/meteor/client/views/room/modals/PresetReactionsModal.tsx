import { Box, Button, ButtonGroup, Modal, Icon, ModalHeader, ModalTitle, ModalClose, ModalContent, ModalFooter } from '@rocket.chat/fuselage';
...
const PresetReactionsModal = ({ initialPresetReactions = [], onConfirm, onCancel }: PresetReactionsModalProps): ReactElement => {
	...
	return (
		<Modal>
			<ModalHeader>
				<ModalTitle>{t('Select_Preset_Reactions')}</ModalTitle>
