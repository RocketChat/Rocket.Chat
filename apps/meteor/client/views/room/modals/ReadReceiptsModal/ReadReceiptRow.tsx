import type { IUser, ReadReceipt } from '@rocket.chat/core-typings';
...
const ReadReceiptRow = ({ user, ts }: ReadReceipt & { user: Pick<IUser, '_id' | 'name' | 'username'> | null }): ReactElement => {
