...
const RoomForeword = ({ user, room }: RoomForewordProps): ReactElement | null => {
	...
	if (!isDirectMessageRoom(room)) {
		return (
			<Box fontScale='c1' color='default' display='flex' justifyContent='center' pb={8}>
	...
	return (
		<Box is='div' flexGrow={1} display='flex' justifyContent='center' flexDirection='column' pb={8}>
			<Flex.Item grow={1}>
