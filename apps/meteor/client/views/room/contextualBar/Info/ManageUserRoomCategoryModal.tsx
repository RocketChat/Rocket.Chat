...
type ManageUserRoomCategoryModalProps = {
	room: IRoom;
	onClose: () => void;
};

const ManageUserRoomCategoryModal = ({ room, onClose }: ManageUserRoomCategoryModalProps) => {
	...
	const openCreateCategoryModal = useCallback(() => {
		setModal(
			<CreateUserRoomCategoryModal
				onClose={() => {
					void refetch();
					setModal(<ManageUserRoomCategoryModal room={room} onClose={onClose} />);
				}}
			/>,
		);
	}, [onClose, refetch, room, setModal]);
	...
	return (
		<Modal aria-labelledby={titleId}>
			<ModalHeader>
				<ModalTitle id={titleId}>{t('Add_to_user_room_category')}</ModalTitle>
...
export default ManageUserRoomCategoryModal;
