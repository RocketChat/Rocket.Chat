						...
						<Field>
							...
							<FieldRow>
								<Controller
									name='urls'
									control={control}
									rules={{ required: t('The_field_is_required', { field: t('URLs') }) }}
									render={({ field }) => (
										<TextAreaInput
											id={urlsField}
											{...field}
						...
						<Field>
							...
							<FieldRow>
								<Controller
									name='username'
									control={control}
									rules={{ required: t('The_field_is_required', { field: t('Post_as') }) }}
									render={({ field }) => (
										<TextInput
											id={usernameField}
											{...field}
						...
						<Field>
							...
							<FieldRow>
								<Controller
									name='token'
									control={control}
									rules={{ required: t('The_field_is_required', { field: t('Token') }) }}
									render={({ field }) => (
										<TextInput
											id={tokenField}
											{...field}
