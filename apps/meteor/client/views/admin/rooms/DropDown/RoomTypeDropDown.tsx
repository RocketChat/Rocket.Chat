...
export const RoomTypeDropDownOptionsContext = createContext<OptionProp[]>([]);

export const RoomTypeDropDown = ({ dropdownOptions, defaultTitle, selectedOptionsTitle }: DropDownProps) => {
	...
	return (
		<>
			<RoomTypeDropDownOptionsContext.Provider value={selectedOptions}>
				<DropDownAnchor
					ref={reference}
			...
			</RoomTypeDropDownOptionsContext.Provider>
		</>
	);
};
