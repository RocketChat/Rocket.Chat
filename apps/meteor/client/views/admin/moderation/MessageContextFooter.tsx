...
const MessageContextFooter: FC<{ userId: string; isUserDeleted?: boolean }> = ({ userId, isUserDeleted }) => {
		...
		<ButtonGroup flexGrow={1}>
			...
			<Menu
				options={{
					...
					deactivate: useDeactivateUserAction(userId, isUserDeleted),
					resetAvatar: useResetAvatarAction(userId, isUserDeleted),
				}}
