...
const webhookTestResponseSchema = ajv.compile<void>({
	type: 'object',
...
const webhookEndpoints = API.v1.post(
...
type WebhookEndpoints = ExtractRoutesFromAPI<typeof webhookEndpoints>;

declare module '@rocket.chat/rest-typings' {
	// eslint-disable-next-line @typescript-eslint/naming-convention, @typescript-eslint/no-empty-interface
	interface Endpoints extends WebhookEndpoints {}
}
