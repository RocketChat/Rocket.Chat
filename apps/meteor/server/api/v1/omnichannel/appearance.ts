import type { ISetting, ISettingSelectOption } from '@rocket.chat/core-typings';
import { Settings } from '@rocket.chat/models';
import {
	ajv,
	isPOSTLivechatAppearanceParams,
...
const appearancePostResponseSchema = ajv.compile<void>({
	type: 'object',
...
API.v1.post(
	'livechat/appearance',
	{
		authRequired: true,
		permissionsRequired: ['view-livechat-manager'],
		body: isPOSTLivechatAppearanceParams,
		response: {
			200: appearancePostResponseSchema,
