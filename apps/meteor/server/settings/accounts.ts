...
export const createAccountSettings = () =>
	settingsRegistry.addGroup('Accounts', async function () {
		...
		await this.section('Accounts_Section_Authentication_Security', async function () {
			...
			await this.add('Login_Logs_Enabled', false, { type: 'boolean', sorter: 3020 });
			await this.add('Login_Logs_Username', false, { type: 'boolean', enableQuery: enableQueryAudit, sorter: 3021 });
			await this.add('Login_Logs_UserAgent', false, { type: 'boolean', enableQuery: enableQueryAudit, sorter: 3022 });
			await this.add('Login_Logs_ClientIp', false, { type: 'boolean', enableQuery: enableQueryAudit, sorter: 3023 });
		...
		await this.section('Accounts_Section_Login_Integrations_Iframe', async function () {
			...
			await this.add('Accounts_iframe_enabled', false, { type: 'boolean', public: true, sorter: 9000 });
			await this.add('Accounts_iframe_url', '', { type: 'string', public: true, sorter: 9001, enableQuery: enableQueryIframe });
			await this.add('Accounts_Iframe_api_url', '', { type: 'string', public: true, sorter: 9002, enableQuery: enableQueryIframe });
