...
export interface IPresence extends IServiceClass {
	newConnection(uid: string, session: string, nodeId: string): Promise<{ uid: string; connectionId: string } | undefined>;
	removeConnection(uid: string, session: string, nodeId: string): Promise<{ uid: string; session: string }>;
