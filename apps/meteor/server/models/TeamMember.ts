...
export class TeamMember extends ModelClass<ITeamMember> implements ITeamMemberModel {
...
registerModel('ITeamMemberModel', new TeamMember(col, trashCollection) as ITeamMemberModel);
