...
describe('FederationEE - Domain - FederatedRoomEE', () => {
	...
	describe('#createInstance()', () => {
		it('should set the internal room name when it was provided', () => {
			const federatedRoom = FederatedRoomEE.createInstance(
				'!externalId@id',
				'externalId',
				{ id: 'userId' } as any,
				'p' as any,
		...
		it('should generate automatically a room name when it was not provided', () => {
			const federatedRoom = FederatedRoomEE.createInstance('!externalId@id', 'externalId', { id: 'userId' } as any, 'p' as any);
		...
		it('should return an instance of FederatedRoom', () => {
			const federatedRoom = FederatedRoomEE.createInstance('!externalId@id', 'externalId', { id: 'userId' } as any, RoomType.CHANNEL);
	...
	describe('#setRoomType()', () => {
		it('should set the Room type if its not a direct message room', () => {
			const federatedRoom = FederatedRoomEE.createInstance('!externalId@id', 'externalId', { id: 'userId' } as any, RoomType.PRIVATE_GROUP);
