import { AirGappedRestriction, License, AirGappedRestrictionLogger } from '@rocket.chat/license';
...
const updateRestrictionSetting = async (remainingDays: number) => {
	AirGappedRestrictionLogger.debug('Updating Cloud_Workspace_AirGapped_Restrictions_Remaining_Days, value: ', remainingDays);
