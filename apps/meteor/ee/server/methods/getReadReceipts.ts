import type { ReadReceipt as IReadReceipt, IMessage, IUser } from '@rocket.chat/core-typings';
...
declare module '@rocket.chat/ddp-client' {
	...
	interface ServerMethods {
		getReadReceipts(options: {
			messageId: IMessage['_id'];
		}): Array<IReadReceipt & { user: Pick<IUser, '_id' | 'name' | 'username'> | null }>;
	}
}
