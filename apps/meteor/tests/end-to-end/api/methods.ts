...
describe('Meteor.methods', () => {
	...
	// `loadMissedMessages` DDP method was removed in favor of `GET /v1/chat.syncMessages`
	// (see apps/meteor/tests/end-to-end/api/chat.ts `[/chat.syncMessages]` for coverage).
