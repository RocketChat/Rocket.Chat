...
export class ChannelCreation extends BasePage {
	...
	private get inputChannelName(): Locator {
		return this.page.locator('[data-qa="create-channel-modal"] [data-qa-type="channel-name-input"]');
	}

	private get inputChannelDescription(): Locator {
		return this.page.locator('[data-qa="create-channel-modal"] [data-qa-type="channel-topic-input"]');
	}
	...
	private get buttonConfirmCreation(): Locator {
		return this.page.locator('[data-qa="create-channel-modal"] [data-qa-type="create-channel-confirm-button"]');
	}

	private get privateChannel(): Locator {
		return this.page.locator('[data-qa="create-channel-modal"] [data-qa-type="channel-private-toggle"]');
	}
