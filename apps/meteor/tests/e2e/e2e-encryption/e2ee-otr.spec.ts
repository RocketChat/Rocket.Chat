...
test.describe('E2EE OTR (Off-The-Record)', () => {
	...
	let disableRoomEncryptionModal: DisableRoomEncryptionModal;
	let enableRoomEncryptionModal: EnableRoomEncryptionModal;
	...
	test.beforeEach(async ({ page }) => {
		...
		disableRoomEncryptionModal = new DisableRoomEncryptionModal(page);
		enableRoomEncryptionModal = new EnableRoomEncryptionModal(page);
