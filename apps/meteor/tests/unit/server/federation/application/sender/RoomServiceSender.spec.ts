...
import type * as RoomServiceSenderModule from '../../../../../../server/services/federation/application/sender/RoomServiceSender';
...
const { FederationRoomServiceSender } = proxyquire
	.noCallThru()
	.load<typeof RoomServiceSenderModule>('../../../../../../server/services/federation/application/sender/RoomServiceSender', {
		'mongodb': {
