...
mock('mongodb', {
    ObjectId: class ObjectId {
        toHexString(): string { return 'hexString' }
    },
});

import { AbstractFederatedRoom, DirectMessageFederatedRoom, FederatedRoom, isAnInternalIdentifier } from '../../../../../../../app/federation-v2/server/domain/FederatedRoom';
...
describe('Federation - Domain - FederatedRoom', () => {
    ...
    describe('FederatedRoom', () => {
        ...
        describe('#createInstance()', () => {
            ...
            it('should throw an error if the user tries to create a DM instance', () => {
                expect(() => FederatedRoom.createInstance(
                    '!externalId@id',
                    'externalId',
                    creator as any,
                    RoomType.DIRECT_MESSAGE,
                )).to.throw('For DMs please use the specific class');
            });
        ...
        describe('#createWithInternalReference()', () => {
            ...
            it('should throw an error if the user tries to create a DM instance', () => {
                expect(() => FederatedRoom.createWithInternalReference(
                    '!externalId@id',
                    { t: RoomType.DIRECT_MESSAGE } as any,
                )).to.throw('For DMs please use the specific class');
            });
    ...
    describe('DirectMessageFederatedRoom', () => {
        ...
        describe('#createInstance()', () => {
            it('should set the creator properly equal to the provided one', () => {
                const federatedRoom = DirectMessageFederatedRoom.createInstance(
                    '!externalId@id',
                    creator as any,
                    [],
                );
        ...
        describe('#getMembersUsernames()', () => {
            it('should return the members usernames', () => {
                const federatedRoom = DirectMessageFederatedRoom.createInstance(
                    '!externalId@id',
                    creator as any,
                    [{ getUsername: () => 'username1' } as any, { getUsername: () => 'username2' } as any],
                );
