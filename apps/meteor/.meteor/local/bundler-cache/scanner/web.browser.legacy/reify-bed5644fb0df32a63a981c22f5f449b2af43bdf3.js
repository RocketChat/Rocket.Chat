var _jsx,_jsxs,_Fragment;module.link("react/jsx-runtime",{jsx:function(v){_jsx=v},jsxs:function(v){_jsxs=v},Fragment:function(v){_Fragment=v}},0);var Tag;module.link('@rocket.chat/fuselage',{Tag:function(v){Tag=v}},1);var format;module.link('date-fns',{format:function(v){format=v}},2);var useContext,useEffect,useState;module.link('react',{useContext:function(v){useContext=v},useEffect:function(v){useEffect=v},useState:function(v){useState=v}},3);var ErrorBoundary;module.link('react-error-boundary',{ErrorBoundary:function(v){ErrorBoundary=v}},4);var MarkupInteractionContext;module.link('../../MarkupInteractionContext',{MarkupInteractionContext:function(v){MarkupInteractionContext=v}},5);var timeAgo;module.link('./timeago',{timeAgo:function(v){timeAgo=v}},6);
