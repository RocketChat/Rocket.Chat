module.export({InviteUserAgentClient:function(){return InviteUserAgentClient}});var Dialog,SessionDialog;module.link("../dialogs",{Dialog:function(v){Dialog=v},SessionDialog:function(v){SessionDialog=v}},0);var SignalingState;module.link("../session",{SignalingState:function(v){SignalingState=v}},1);var InviteClientTransaction,TransactionState;module.link("../transactions",{InviteClientTransaction:function(v){InviteClientTransaction=v},TransactionState:function(v){TransactionState=v}},2);var UserAgentClient;module.link("./user-agent-client",{UserAgentClient:function(v){UserAgentClient=v}},3);
