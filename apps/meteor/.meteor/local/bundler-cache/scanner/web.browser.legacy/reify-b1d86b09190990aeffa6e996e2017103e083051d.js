var _Fragment,_jsx,_jsxs;module.link("react/jsx-runtime",{Fragment:function(v){_Fragment=v},jsx:function(v){_jsx=v},jsxs:function(v){_jsxs=v}},0);var hljs;module.link('highlight.js',{default:function(v){hljs=v}},1);var Fragment,useContext,useLayoutEffect,useMemo,useRef;module.link('react',{Fragment:function(v){Fragment=v},useContext:function(v){useContext=v},useLayoutEffect:function(v){useLayoutEffect=v},useMemo:function(v){useMemo=v},useRef:function(v){useRef=v}},2);var MarkupInteractionContext;module.link('../MarkupInteractionContext',{MarkupInteractionContext:function(v){MarkupInteractionContext=v}},3);
