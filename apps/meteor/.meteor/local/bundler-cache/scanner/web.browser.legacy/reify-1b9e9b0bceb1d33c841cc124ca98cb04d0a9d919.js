var _jsx;module.link("react/jsx-runtime",{jsx:function(v){_jsx=v}},0);var IconButton;module.link('@rocket.chat/fuselage',{IconButton:function(v){IconButton=v}},1);var GenericMenu;module.link('@rocket.chat/ui-client',{GenericMenu:function(v){GenericMenu=v}},2);var forwardRef;module.link('react',{forwardRef:function(v){forwardRef=v}},3);var useVoipDeviceSettings;module.link('./hooks/useVoipDeviceSettings',{useVoipDeviceSettings:function(v){useVoipDeviceSettings=v}},4);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
