module.export({Session:function(){return Session}});var fromBodyLegacy,getBody,Grammar,SessionDialogState,SignalingState,URI;module.link("../core",{fromBodyLegacy:function(v){fromBodyLegacy=v},getBody:function(v){getBody=v},Grammar:function(v){Grammar=v},SessionState:function(v){SessionDialogState=v},SignalingState:function(v){SignalingState=v},URI:function(v){URI=v}},0);var getReasonPhrase;module.link("../core/messages/utils",{getReasonPhrase:function(v){getReasonPhrase=v}},1);var AllowedMethods;module.link("../core/user-agent-core/allowed-methods",{AllowedMethods:function(v){AllowedMethods=v}},2);var Ack;module.link("./ack",{Ack:function(v){Ack=v}},3);var Bye;module.link("./bye",{Bye:function(v){Bye=v}},4);var EmitterImpl;module.link("./emitter",{EmitterImpl:function(v){EmitterImpl=v}},5);var ContentTypeUnsupportedError,RequestPendingError;module.link("./exceptions",{ContentTypeUnsupportedError:function(v){ContentTypeUnsupportedError=v},RequestPendingError:function(v){RequestPendingError=v}},6);var Info;module.link("./info",{Info:function(v){Info=v}},7);var Message;module.link("./message",{Message:function(v){Message=v}},8);var Notification;module.link("./notification",{Notification:function(v){Notification=v}},9);var Referral;module.link("./referral",{Referral:function(v){Referral=v}},10);var SessionState;module.link("./session-state",{SessionState:function(v){SessionState=v}},11);
