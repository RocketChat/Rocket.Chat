module.export({default:function(){return LocalStream}});var defaultMediaStreamFactory;module.link('sip.js/lib/platform/web',{defaultMediaStreamFactory:function(v){defaultMediaStreamFactory=v}},0);var Stream;module.link('./Stream',{default:function(v){Stream=v}},1);/**
