...
var ActionLink = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(fuselage_1.Box, __assign({}, props, { is: 'a', fontScale: 'p2', href: href, color: 'info', mi: 4, textDecorationLine: 'none', onClick: handleClick }, { children: children })));
};
