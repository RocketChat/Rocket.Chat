var _jsx;module.link("react/jsx-runtime",{jsx:function(v){_jsx=v}},0);var Button;module.link('@rocket.chat/fuselage',{Button:function(v){Button=v}},1);var useLoginWithService;module.link('@rocket.chat/ui-contexts',{useLoginWithService:function(v){useLoginWithService=v}},2);var useCallback;module.link('react',{useCallback:function(v){useCallback=v}},3);var useTranslation;module.link('react-i18next',{useTranslation:function(v){useTranslation=v}},4);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
