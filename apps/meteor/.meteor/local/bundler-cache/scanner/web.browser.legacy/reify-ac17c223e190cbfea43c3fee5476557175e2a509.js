...
var List = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(List_styles_1.ListComponent, __assign({ icon: icon, listStyleType: listStyleType, color: color }, { children: (0, jsx_runtime_1.jsx)(fuselage_1.Margins, __assign({ block: spacing }, { children: children })) })));
};
