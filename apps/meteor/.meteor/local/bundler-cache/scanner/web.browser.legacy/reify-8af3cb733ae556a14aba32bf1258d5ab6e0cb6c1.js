module.export({CustomFieldsForm:function(){return CustomFieldsForm}},true);var _jsx,_jsxs,_Fragment;module.link("react/jsx-runtime",{jsx:function(v){_jsx=v},jsxs:function(v){_jsxs=v},Fragment:function(v){_Fragment=v}},0);var Field,FieldLabel,FieldRow,FieldError,Select,TextInput;module.link('@rocket.chat/fuselage',{Field:function(v){Field=v},FieldLabel:function(v){FieldLabel=v},FieldRow:function(v){FieldRow=v},FieldError:function(v){FieldError=v},Select:function(v){Select=v},TextInput:function(v){TextInput=v}},1);var useUniqueId;module.link('@rocket.chat/fuselage-hooks',{useUniqueId:function(v){useUniqueId=v}},2);var useCallback,useMemo;module.link('react',{useCallback:function(v){useCallback=v},useMemo:function(v){useMemo=v}},3);var Controller,useFormState,get;module.link('react-hook-form',{Controller:function(v){Controller=v},useFormState:function(v){useFormState=v},get:function(v){get=v}},4);var useTranslation;module.link('react-i18next',{useTranslation:function(v){useTranslation=v}},5);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
