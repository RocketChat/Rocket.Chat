module.export({UserAgentCore:function(){return UserAgentCore}});var C,constructOutgoingResponse,OutgoingRequestMessage;module.link("../messages",{C:function(v){C=v},constructOutgoingResponse:function(v){constructOutgoingResponse=v},OutgoingRequestMessage:function(v){OutgoingRequestMessage=v}},0);var InviteServerTransaction,NonInviteClientTransaction,TransactionState;module.link("../transactions",{InviteServerTransaction:function(v){InviteServerTransaction=v},NonInviteClientTransaction:function(v){NonInviteClientTransaction=v},TransactionState:function(v){TransactionState=v}},1);var InviteUserAgentClient,InviteUserAgentServer,MessageUserAgentClient,MessageUserAgentServer,NotifyUserAgentServer,PublishUserAgentClient,ReferUserAgentServer,RegisterUserAgentClient,RegisterUserAgentServer,SubscribeUserAgentClient,SubscribeUserAgentServer,UserAgentClient;module.link("../user-agents",{InviteUserAgentClient:function(v){InviteUserAgentClient=v},InviteUserAgentServer:function(v){InviteUserAgentServer=v},MessageUserAgentClient:function(v){MessageUserAgentClient=v},MessageUserAgentServer:function(v){MessageUserAgentServer=v},NotifyUserAgentServer:function(v){NotifyUserAgentServer=v},PublishUserAgentClient:function(v){PublishUserAgentClient=v},ReferUserAgentServer:function(v){ReferUserAgentServer=v},RegisterUserAgentClient:function(v){RegisterUserAgentClient=v},RegisterUserAgentServer:function(v){RegisterUserAgentServer=v},SubscribeUserAgentClient:function(v){SubscribeUserAgentClient=v},SubscribeUserAgentServer:function(v){SubscribeUserAgentServer=v},UserAgentClient:function(v){UserAgentClient=v}},2);var AllowedMethods;module.link("./allowed-methods",{AllowedMethods:function(v){AllowedMethods=v}},3);
