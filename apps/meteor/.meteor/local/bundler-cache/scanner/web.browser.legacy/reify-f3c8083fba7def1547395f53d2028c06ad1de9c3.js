...
var OrganizationInfoPage = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(layout_1.BackgroundLayer, { children: (0, jsx_runtime_1.jsx)(FormPageLayout_1.default, __assign({ styleProps: pageLayoutStyleProps, title: title, description: description }, { children: (0, jsx_runtime_1.jsx)(OrganizationInfoForm_1.default, __assign({}, props)) })) }));
};
