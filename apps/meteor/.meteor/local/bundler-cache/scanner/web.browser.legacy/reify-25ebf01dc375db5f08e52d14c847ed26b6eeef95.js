var _jsx,_jsxs;module.link("react/jsx-runtime",{jsx:function(v){_jsx=v},jsxs:function(v){_jsxs=v}},0);var useEffectEvent,useLocalStorage;module.link('@rocket.chat/fuselage-hooks',{useEffectEvent:function(v){useEffectEvent=v},useLocalStorage:function(v){useLocalStorage=v}},1);var usePermission,useSetInputMediaDevice,useSetOutputMediaDevice,useSetting,useToastMessageDispatch;module.link('@rocket.chat/ui-contexts',{usePermission:function(v){usePermission=v},useSetInputMediaDevice:function(v){useSetInputMediaDevice=v},useSetOutputMediaDevice:function(v){useSetOutputMediaDevice=v},useSetting:function(v){useSetting=v},useToastMessageDispatch:function(v){useToastMessageDispatch=v}},2);var useEffect,useMemo,useRef;module.link('react',{useEffect:function(v){useEffect=v},useMemo:function(v){useMemo=v},useRef:function(v){useRef=v}},3);var createPortal;module.link('react-dom',{createPortal:function(v){createPortal=v}},4);var useTranslation;module.link('react-i18next',{useTranslation:function(v){useTranslation=v}},5);var VoipPopup;module.link('../components/VoipPopup',{default:function(v){VoipPopup=v}},6);var VoipPopupPortal;module.link('../components/VoipPopupPortal',{default:function(v){VoipPopupPortal=v}},7);var VoipContext;module.link('../contexts/VoipContext',{VoipContext:function(v){VoipContext=v}},8);var useVoipClient;module.link('../hooks/useVoipClient',{useVoipClient:function(v){useVoipClient=v}},9);var useVoipSounds;module.link('../hooks/useVoipSounds',{useVoipSounds:function(v){useVoipSounds=v}},10);var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
