...
var compileOperations = function (_a) {
            ...
            switch (value) {
                ...
                case 'inline-start':
                    if (!logicalValues.get(value)) {
                        (0, elements_1.attachDeclaration)(property, 'left', ruleSet);
                        (0, elements_1.attachDeclaration)(property, 'right', rtlRuleSet);
                        return;
                    }
                    break;
                case 'end':
                case 'inline-end':
                    if (!logicalValues.get(value)) {
                        (0, elements_1.attachDeclaration)(property, 'right', ruleSet);
                        (0, elements_1.attachDeclaration)(property, 'left', rtlRuleSet);
                        return;
                    }
                    break;
            }
            (0, elements_1.attachDeclaration)(property, value, ruleSet);
        };
        ops.set(property, op);
    };
    var withDirectionalFallback = function (property, ltrFallbackProperty, rtlFallbackProperty) {
        ...
        var op = function (value, _ruleSet, ltrRuleSet, rtlRuleSet) {
            (0, elements_1.attachDeclaration)(ltrFallbackProperty, value, ltrRuleSet);
            (0, elements_1.attachDeclaration)(rtlFallbackProperty, value, rtlRuleSet);
        };
        ops.set(property, op);
    };
    var withFallback = function (property) {
        ...
        var op = function (value, ruleSet, ltrRuleSet, rtlRuleSet) {
            for (var _i = 0, fallbackProperties_1 = fallbackProperties; _i < fallbackProperties_1.length; _i++) {
                ...
                (0, elements_1.attachDeclaration)(fallbackProperty, value, ruleSet);
            }
        };
        ops.set(property, op);
    };
