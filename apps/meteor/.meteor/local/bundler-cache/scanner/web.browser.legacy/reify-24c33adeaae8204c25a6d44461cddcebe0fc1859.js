module.export({PasswordPolicy:function(){return PasswordPolicy}});var PasswordPolicyError;module.link('./PasswordPolicyError',{PasswordPolicyError:function(v){PasswordPolicyError=v}},0);
class PasswordPolicy {
    constructor({ enabled = false, minLength = -1, maxLength = -1, forbidRepeatingCharacters = false, forbidRepeatingCharactersCount = 3, // the regex is this number minus one
    mustContainAtLeastOneLowercase = false, // /[A-Z]{3,}/ could do this instead of at least one
    mustContainAtLeastOneUppercase = false, mustContainAtLeastOneNumber = false, mustContainAtLeastOneSpecialCharacter = false, throwError = true, }) {
    ...
    sendValidationMessage(password) {
