...
var isActionsBlockElement = function (block) {
    switch (block.type) {
        ...
        case BlockElementType_1.BlockElementType.TOGGLE_SWITCH:
        case BlockElementType_1.BlockElementType.CHECKBOX:
        case BlockElementType_1.BlockElementType.RADIO_BUTTON:
        case BlockElementType_1.BlockElementType.TIME_PICKER:
            return true;
        default:
            return false;
    }
