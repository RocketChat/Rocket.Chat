module.export({MultiSelectCustom:function(){return MultiSelectCustom}},true);var _jsx,_jsxs;module.link("react/jsx-runtime",{jsx:function(v){_jsx=v},jsxs:function(v){_jsxs=v}},0);var Box;module.link('@rocket.chat/fuselage',{Box:function(v){Box=v}},1);var useOutsideClick,useToggle;module.link('@rocket.chat/fuselage-hooks',{useOutsideClick:function(v){useOutsideClick=v},useToggle:function(v){useToggle=v}},2);var useCallback,useRef;module.link('react',{useCallback:function(v){useCallback=v},useRef:function(v){useRef=v}},3);var MultiSelectCustomAnchor;module.link('./MultiSelectCustomAnchor',{default:function(v){MultiSelectCustomAnchor=v}},4);var MultiSelectCustomList;module.link('./MultiSelectCustomList',{default:function(v){MultiSelectCustomList=v}},5);var MultiSelectCustomListWrapper;module.link('./MultiSelectCustomListWrapper',{default:function(v){MultiSelectCustomListWrapper=v}},6);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
