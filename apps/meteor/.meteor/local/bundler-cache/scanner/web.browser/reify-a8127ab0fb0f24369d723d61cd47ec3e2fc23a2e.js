module.export({RegisterForm:()=>RegisterForm},true);let _jsx,_jsxs;module.link("react/jsx-runtime",{jsx(v){_jsx=v},jsxs(v){_jsxs=v}},0);let FieldGroup,TextInput,Field,FieldLabel,FieldRow,FieldError,PasswordInput,ButtonGroup,Button,TextAreaInput,Callout;module.link('@rocket.chat/fuselage',{FieldGroup(v){FieldGroup=v},TextInput(v){TextInput=v},Field(v){Field=v},FieldLabel(v){FieldLabel=v},FieldRow(v){FieldRow=v},FieldError(v){FieldError=v},PasswordInput(v){PasswordInput=v},ButtonGroup(v){ButtonGroup=v},Button(v){Button=v},TextAreaInput(v){TextAreaInput=v},Callout(v){Callout=v}},1);let useUniqueId;module.link('@rocket.chat/fuselage-hooks',{useUniqueId(v){useUniqueId=v}},2);let Form,ActionLink;module.link('@rocket.chat/layout',{Form(v){Form=v},ActionLink(v){ActionLink=v}},3);let CustomFieldsForm,PasswordVerifier,useValidatePassword;module.link('@rocket.chat/ui-client',{CustomFieldsForm(v){CustomFieldsForm=v},PasswordVerifier(v){PasswordVerifier=v},useValidatePassword(v){useValidatePassword=v}},4);let useAccountsCustomFields,useSetting,useToastMessageDispatch;module.link('@rocket.chat/ui-contexts',{useAccountsCustomFields(v){useAccountsCustomFields=v},useSetting(v){useSetting=v},useToastMessageDispatch(v){useToastMessageDispatch=v}},5);let useEffect,useRef,useState;module.link('react',{useEffect(v){useEffect=v},useRef(v){useRef=v},useState(v){useState=v}},6);let useForm;module.link('react-hook-form',{useForm(v){useForm=v}},7);let Trans,useTranslation;module.link('react-i18next',{Trans(v){Trans=v},useTranslation(v){useTranslation=v}},8);let EmailConfirmationForm;module.link('./EmailConfirmationForm',{default(v){EmailConfirmationForm=v}},9);let useRegisterMethod;module.link('./hooks/useRegisterMethod',{useRegisterMethod(v){useRegisterMethod=v}},10);var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
