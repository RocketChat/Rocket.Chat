module.export({Inviter:()=>Inviter});let Grammar;module.link("../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let C;module.link("../core/messages/methods/constants.js",{C(v){C=v}},1);let SignalingState;module.link("../core/session/session.js",{SignalingState(v){SignalingState=v}},2);let getReasonPhrase,newTag;module.link("../core/messages/utils.js",{getReasonPhrase(v){getReasonPhrase=v},newTag(v){newTag=v}},3);let Session;module.link("./session.js",{Session(v){Session=v}},4);let SessionState;module.link("./session-state.js",{SessionState(v){SessionState=v}},5);let SIPExtension;module.link("./user-agent-options.js",{SIPExtension(v){SIPExtension=v}},6);
