module.export({Subscription:()=>Subscription});let EmitterImpl;module.link("./emitter.js",{EmitterImpl(v){EmitterImpl=v}},0);let SubscriptionState;module.link("./subscription-state.js",{SubscriptionState(v){SubscriptionState=v}},1);
