module.export({Registerer:()=>Registerer});let Grammar;module.link("../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let equivalentURI,URI;module.link("../grammar/uri.js",{equivalentURI(v){equivalentURI=v},URI(v){URI=v}},1);let C;module.link("../core/messages/methods/constants.js",{C(v){C=v}},2);let EmitterImpl;module.link("./emitter.js",{EmitterImpl(v){EmitterImpl=v}},3);let RequestPendingError;module.link("./exceptions/request-pending.js",{RequestPendingError(v){RequestPendingError=v}},4);let RegistererState;module.link("./registerer-state.js",{RegistererState(v){RegistererState=v}},5);
