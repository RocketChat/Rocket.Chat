module.export({SubscriptionDialog:()=>SubscriptionDialog});let NameAddrHeader;module.link("../../grammar/name-addr-header.js",{NameAddrHeader(v){NameAddrHeader=v}},0);let C;module.link("../messages/methods/constants.js",{C(v){C=v}},1);let SubscriptionState;module.link("../subscription/subscription.js",{SubscriptionState(v){SubscriptionState=v}},2);let Timers;module.link("../timers.js",{Timers(v){Timers=v}},3);let AllowedMethods;module.link("../user-agent-core/allowed-methods.js",{AllowedMethods(v){AllowedMethods=v}},4);let NotifyUserAgentServer;module.link("../user-agents/notify-user-agent-server.js",{NotifyUserAgentServer(v){NotifyUserAgentServer=v}},5);let ReSubscribeUserAgentClient;module.link("../user-agents/re-subscribe-user-agent-client.js",{ReSubscribeUserAgentClient(v){ReSubscribeUserAgentClient=v}},6);let Dialog;module.link("./dialog.js",{Dialog(v){Dialog=v}},7);
