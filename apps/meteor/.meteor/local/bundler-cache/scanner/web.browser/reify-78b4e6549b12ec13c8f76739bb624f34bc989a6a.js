let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},0);let Button;module.link('@rocket.chat/fuselage',{Button(v){Button=v}},1);let useLoginWithService;module.link('@rocket.chat/ui-contexts',{useLoginWithService(v){useLoginWithService=v}},2);let useCallback;module.link('react',{useCallback(v){useCallback=v}},3);let useTranslation;module.link('react-i18next',{useTranslation(v){useTranslation=v}},4);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
