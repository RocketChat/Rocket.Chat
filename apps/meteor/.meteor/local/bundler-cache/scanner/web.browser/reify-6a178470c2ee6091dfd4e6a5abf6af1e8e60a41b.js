module.export({Subscriber:()=>Subscriber});let C,fromBodyLegacy,SubscriptionDialogState;module.link("../core",{C(v){C=v},fromBodyLegacy(v){fromBodyLegacy=v},SubscriptionState(v){SubscriptionDialogState=v}},0);let AllowedMethods;module.link("../core/user-agent-core/allowed-methods",{AllowedMethods(v){AllowedMethods=v}},1);let Notification;module.link("./notification",{Notification(v){Notification=v}},2);let Subscription;module.link("./subscription",{Subscription(v){Subscription=v}},3);let SubscriptionState;module.link("./subscription-state",{SubscriptionState(v){SubscriptionState=v}},4);
