module.export({NonInviteServerTransaction:()=>NonInviteServerTransaction});let Timers;module.link("../timers.js",{Timers(v){Timers=v}},0);let ServerTransaction;module.link("./server-transaction.js",{ServerTransaction(v){ServerTransaction=v}},1);let TransactionState;module.link("./transaction-state.js",{TransactionState(v){TransactionState=v}},2);
