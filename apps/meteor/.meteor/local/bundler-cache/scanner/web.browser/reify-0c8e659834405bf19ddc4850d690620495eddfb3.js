module.export({Parser:()=>Parser});let Grammar;module.link("../../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let IncomingRequestMessage;module.link("./incoming-request-message.js",{IncomingRequestMessage(v){IncomingRequestMessage=v}},1);let IncomingResponseMessage;module.link("./incoming-response-message.js",{IncomingResponseMessage(v){IncomingResponseMessage=v}},2);/* eslint-disable no-inner-declarations */
...
})(module.runSetters(Parser = Parser || (module.runSetters(Parser = {},["Parser"])),["Parser"]));
