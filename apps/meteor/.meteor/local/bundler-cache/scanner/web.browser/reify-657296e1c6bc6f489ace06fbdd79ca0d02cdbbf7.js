module.export({I18nProvider:()=>$18f2051aff69b9bf$export$a54013f0d02a8f82,useLocale:()=>$18f2051aff69b9bf$export$43bb16f9c6d9e3f7,useLocalizedStringFormatter:()=>$fca6afa0e843324b$export$f12b703ca79dfbb1,useLocalizedStringDictionary:()=>$fca6afa0e843324b$export$87b761675e8eaa10,useListFormatter:()=>$33bf17300c498528$export$a2f47a3d2973640,useDateFormatter:()=>$896ba0a80a8f4d36$export$85fd5fdf27bacc79,useNumberFormatter:()=>$a916eb452884faea$export$b7a616150fdb9f44,useCollator:()=>$325a3faab7a68acd$export$a16aca283550c30d,useFilter:()=>$bb77f239b46e8c72$export$3274cf84b703fff});let $iFADg$react,$iFADg$useContext,$iFADg$useState,$iFADg$useEffect,$iFADg$useMemo,$iFADg$useCallback;module.link("react",{default(v){$iFADg$react=v},useContext(v){$iFADg$useContext=v},useState(v){$iFADg$useState=v},useEffect(v){$iFADg$useEffect=v},useMemo(v){$iFADg$useMemo=v},useCallback(v){$iFADg$useCallback=v}},0);let $iFADg$useIsSSR;module.link("@react-aria/ssr",{useIsSSR(v){$iFADg$useIsSSR=v}},1);let $iFADg$LocalizedStringDictionary,$iFADg$LocalizedStringFormatter;module.link("@internationalized/string",{LocalizedStringDictionary(v){$iFADg$LocalizedStringDictionary=v},LocalizedStringFormatter(v){$iFADg$LocalizedStringFormatter=v}},2);let $iFADg$DateFormatter;module.link("@internationalized/date",{DateFormatter(v){$iFADg$DateFormatter=v}},3);let $iFADg$useDeepMemo;module.link("@react-aria/utils",{useDeepMemo(v){$iFADg$useDeepMemo=v}},4);let $iFADg$NumberFormatter;module.link("@internationalized/number",{NumberFormatter(v){$iFADg$NumberFormatter=v}},5);
