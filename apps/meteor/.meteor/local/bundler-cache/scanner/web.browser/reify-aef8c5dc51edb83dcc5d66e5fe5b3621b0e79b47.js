let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},0);let useMemo,useContext,memo;module.link('react',{useMemo(v){useMemo=v},useContext(v){useContext=v},memo(v){memo=v}},1);let MarkupInteractionContext;module.link('../MarkupInteractionContext',{MarkupInteractionContext(v){MarkupInteractionContext=v}},2);let PlainSpan;module.link('../elements/PlainSpan',{default(v){PlainSpan=v}},3);let EmojiRenderer;module.link('./EmojiRenderer',{default(v){EmojiRenderer=v}},4);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
