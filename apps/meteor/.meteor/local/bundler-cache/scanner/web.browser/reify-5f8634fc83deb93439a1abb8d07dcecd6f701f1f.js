module.export({Publisher:()=>Publisher});let fromBodyLegacy;module.link("../core/messages/body.js",{fromBodyLegacy(v){fromBodyLegacy=v}},0);let C;module.link("../core/messages/methods/constants.js",{C(v){C=v}},1);let EmitterImpl;module.link("./emitter.js",{EmitterImpl(v){EmitterImpl=v}},2);let PublisherState;module.link("./publisher-state.js",{PublisherState(v){PublisherState=v}},3);
