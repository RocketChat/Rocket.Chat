module.export({ContextualBarSurfaceRenderer:()=>ContextualBarSurfaceRenderer});let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},0);let UiKit;module.link('@rocket.chat/ui-kit',{"*"(v){UiKit=v}},1);let FuselageSurfaceRenderer,renderTextObject;module.link('./FuselageSurfaceRenderer',{FuselageSurfaceRenderer(v){FuselageSurfaceRenderer=v},renderTextObject(v){renderTextObject=v}},2);let TabNavigationBlock;module.link('../blocks/TabNavigationBlock',{default(v){TabNavigationBlock=v}},3);let AppIdProvider;module.link('../contexts/AppIdContext',{AppIdProvider(v){AppIdProvider=v}},4);
