module.export({SessionDialog:()=>SessionDialog});let NameAddrHeader;module.link("../../grammar/name-addr-header.js",{NameAddrHeader(v){NameAddrHeader=v}},0);let getBody,isBody;module.link("../messages/body.js",{getBody(v){getBody=v},isBody(v){isBody=v}},1);let C;module.link("../messages/methods/constants.js",{C(v){C=v}},2);let IncomingRequestMessage;module.link("../messages/incoming-request-message.js",{IncomingRequestMessage(v){IncomingRequestMessage=v}},3);let IncomingResponseMessage;module.link("../messages/incoming-response-message.js",{IncomingResponseMessage(v){IncomingResponseMessage=v}},4);let OutgoingRequestMessage;module.link("../messages/outgoing-request-message.js",{OutgoingRequestMessage(v){OutgoingRequestMessage=v}},5);let SessionState;module.link("../session/session.js",{SessionState(v){SessionState=v}},6);let SignalingState;module.link("../session/session.js",{SignalingState(v){SignalingState=v}},7);let Timers;module.link("../timers.js",{Timers(v){Timers=v}},8);let InviteClientTransaction;module.link("../transactions/invite-client-transaction.js",{InviteClientTransaction(v){InviteClientTransaction=v}},9);let InviteServerTransaction;module.link("../transactions/invite-server-transaction.js",{InviteServerTransaction(v){InviteServerTransaction=v}},10);let TransactionState;module.link("../transactions/transaction-state.js",{TransactionState(v){TransactionState=v}},11);let ByeUserAgentClient;module.link("../user-agents/bye-user-agent-client.js",{ByeUserAgentClient(v){ByeUserAgentClient=v}},12);let ByeUserAgentServer;module.link("../user-agents/bye-user-agent-server.js",{ByeUserAgentServer(v){ByeUserAgentServer=v}},13);let InfoUserAgentClient;module.link("../user-agents/info-user-agent-client.js",{InfoUserAgentClient(v){InfoUserAgentClient=v}},14);let InfoUserAgentServer;module.link("../user-agents/info-user-agent-server.js",{InfoUserAgentServer(v){InfoUserAgentServer=v}},15);let MessageUserAgentClient;module.link("../user-agents/message-user-agent-client.js",{MessageUserAgentClient(v){MessageUserAgentClient=v}},16);let MessageUserAgentServer;module.link("../user-agents/message-user-agent-server.js",{MessageUserAgentServer(v){MessageUserAgentServer=v}},17);let NotifyUserAgentClient;module.link("../user-agents/notify-user-agent-client.js",{NotifyUserAgentClient(v){NotifyUserAgentClient=v}},18);let NotifyUserAgentServer;module.link("../user-agents/notify-user-agent-server.js",{NotifyUserAgentServer(v){NotifyUserAgentServer=v}},19);let PrackUserAgentClient;module.link("../user-agents/prack-user-agent-client.js",{PrackUserAgentClient(v){PrackUserAgentClient=v}},20);let PrackUserAgentServer;module.link("../user-agents/prack-user-agent-server.js",{PrackUserAgentServer(v){PrackUserAgentServer=v}},21);let ReInviteUserAgentClient;module.link("../user-agents/re-invite-user-agent-client.js",{ReInviteUserAgentClient(v){ReInviteUserAgentClient=v}},22);let ReInviteUserAgentServer;module.link("../user-agents/re-invite-user-agent-server.js",{ReInviteUserAgentServer(v){ReInviteUserAgentServer=v}},23);let ReferUserAgentClient;module.link("../user-agents/refer-user-agent-client.js",{ReferUserAgentClient(v){ReferUserAgentClient=v}},24);let ReferUserAgentServer;module.link("../user-agents/refer-user-agent-server.js",{ReferUserAgentServer(v){ReferUserAgentServer=v}},25);let Dialog;module.link("./dialog.js",{Dialog(v){Dialog=v}},26);
