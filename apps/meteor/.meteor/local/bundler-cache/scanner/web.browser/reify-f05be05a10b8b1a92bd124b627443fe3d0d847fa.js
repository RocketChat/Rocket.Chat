module.export({Parser:()=>Parser});let Grammar;module.link("../../grammar",{Grammar(v){Grammar=v}},0);let IncomingRequestMessage;module.link("./incoming-request-message",{IncomingRequestMessage(v){IncomingRequestMessage=v}},1);let IncomingResponseMessage;module.link("./incoming-response-message",{IncomingResponseMessage(v){IncomingResponseMessage=v}},2);/* eslint-disable no-inner-declarations */
