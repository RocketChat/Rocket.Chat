module.export({Invitation:()=>Invitation});let Grammar;module.link("../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let fromBodyLegacy,getBody;module.link("../core/messages/body.js",{fromBodyLegacy(v){fromBodyLegacy=v},getBody(v){getBody=v}},1);let SignalingState;module.link("../core/session/session.js",{SignalingState(v){SignalingState=v}},2);let Timers;module.link("../core/timers.js",{Timers(v){Timers=v}},3);let TransactionStateError;module.link("../core/exceptions/transaction-state-error.js",{TransactionStateError(v){TransactionStateError=v}},4);let getReasonPhrase;module.link("../core/messages/utils.js",{getReasonPhrase(v){getReasonPhrase=v}},5);let Cancel;module.link("./cancel.js",{Cancel(v){Cancel=v}},6);let ContentTypeUnsupportedError;module.link("./exceptions/content-type-unsupported.js",{ContentTypeUnsupportedError(v){ContentTypeUnsupportedError=v}},7);let SessionDescriptionHandlerError;module.link("./exceptions/session-description-handler.js",{SessionDescriptionHandlerError(v){SessionDescriptionHandlerError=v}},8);let SessionTerminatedError;module.link("./exceptions/session-terminated.js",{SessionTerminatedError(v){SessionTerminatedError=v}},9);let Session;module.link("./session.js",{Session(v){Session=v}},10);let SessionState;module.link("./session-state.js",{SessionState(v){SessionState=v}},11);let SIPExtension;module.link("./user-agent-options.js",{SIPExtension(v){SIPExtension=v}},12);
