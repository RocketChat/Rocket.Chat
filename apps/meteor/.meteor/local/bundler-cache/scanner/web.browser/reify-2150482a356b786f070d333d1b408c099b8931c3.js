'use client';module.export({useIsFetching:()=>useIsFetching});let React;module.link('react',{"*"(v){React=v}},0);let parseFilterArgs,notifyManager;module.link('@tanstack/query-core',{parseFilterArgs(v){parseFilterArgs=v},notifyManager(v){notifyManager=v}},1);let useSyncExternalStore;module.link('./useSyncExternalStore.esm.js',{useSyncExternalStore(v){useSyncExternalStore=v}},2);let useQueryClient;module.link('./QueryClientProvider.esm.js',{useQueryClient(v){useQueryClient=v}},3);
