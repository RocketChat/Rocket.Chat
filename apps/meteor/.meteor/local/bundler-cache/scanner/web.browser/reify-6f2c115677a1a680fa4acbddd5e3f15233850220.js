module.export({InviteUserAgentServer:()=>InviteUserAgentServer});let Dialog;module.link("../dialogs/dialog.js",{Dialog(v){Dialog=v}},0);let SessionDialog;module.link("../dialogs/session-dialog.js",{SessionDialog(v){SessionDialog=v}},1);let TransactionStateError;module.link("../exceptions/transaction-state-error.js",{TransactionStateError(v){TransactionStateError=v}},2);let SignalingState;module.link("../session/session.js",{SignalingState(v){SignalingState=v}},3);let InviteServerTransaction;module.link("../transactions/invite-server-transaction.js",{InviteServerTransaction(v){InviteServerTransaction=v}},4);let AllowedMethods;module.link("../user-agent-core/allowed-methods.js",{AllowedMethods(v){AllowedMethods=v}},5);let UserAgentServer;module.link("./user-agent-server.js",{UserAgentServer(v){UserAgentServer=v}},6);
