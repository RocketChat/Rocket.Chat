module.export({ToastBarContainer:()=>ToastBarContainer});let _jsx;module.link("react/jsx-runtime",{jsx(v){_jsx=v}},0);let styled;module.link('@rocket.chat/styled',{default(v){styled=v}},1);var __makeTemplateObject = (this && this.__makeTemplateObject) || function (cooked, raw) {
...
var ToastBarContainer = styled('div', function (_a) {
...
var ToastBarZone = function (_a) {
    ...
    return (_jsx(ToastBarContainer, { position: position, children: children }));
};
module.exportDefault(ToastBarZone);
