module.export({SubscribeUserAgentClient:()=>SubscribeUserAgentClient});let SubscriptionDialog;module.link("../dialogs/subscription-dialog.js",{SubscriptionDialog(v){SubscriptionDialog=v}},0);let SubscriptionState;module.link("../subscription/subscription.js",{SubscriptionState(v){SubscriptionState=v}},1);let Timers;module.link("../timers.js",{Timers(v){Timers=v}},2);let NonInviteClientTransaction;module.link("../transactions/non-invite-client-transaction.js",{NonInviteClientTransaction(v){NonInviteClientTransaction=v}},3);let UserAgentClient;module.link("./user-agent-client.js",{UserAgentClient(v){UserAgentClient=v}},4);
