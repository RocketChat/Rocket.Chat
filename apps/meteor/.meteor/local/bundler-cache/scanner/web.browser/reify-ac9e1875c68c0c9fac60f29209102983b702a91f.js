module.export({Grammar:()=>Grammar});let pegGrammar;module.link("./pegjs/dist/grammar.js",{"*"(v){pegGrammar=v}},0);/* eslint-disable @typescript-eslint/no-namespace */
...
})(module.runSetters(Grammar = Grammar || (module.runSetters(Grammar = {},["Grammar"])),["Grammar"]));
