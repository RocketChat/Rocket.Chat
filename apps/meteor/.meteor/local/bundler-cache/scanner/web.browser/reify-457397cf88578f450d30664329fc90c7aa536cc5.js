module.export({Transport:()=>Transport});let EmitterImpl;module.link("../../../api/emitter.js",{EmitterImpl(v){EmitterImpl=v}},0);let StateTransitionError;module.link("../../../api/exceptions/state-transition.js",{StateTransitionError(v){StateTransitionError=v}},1);let TransportState;module.link("../../../api/transport-state.js",{TransportState(v){TransportState=v}},2);let Grammar;module.link("../../../grammar/grammar.js",{Grammar(v){Grammar=v}},3);
