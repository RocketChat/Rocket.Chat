module.export({Subscriber:()=>Subscriber});let fromBodyLegacy;module.link("../core/messages/body.js",{fromBodyLegacy(v){fromBodyLegacy=v}},0);let C;module.link("../core/messages/methods/constants.js",{C(v){C=v}},1);let SubscriptionDialogState;module.link("../core/subscription/subscription.js",{SubscriptionState(v){SubscriptionDialogState=v}},2);let AllowedMethods;module.link("../core/user-agent-core/allowed-methods.js",{AllowedMethods(v){AllowedMethods=v}},3);let Notification;module.link("./notification.js",{Notification(v){Notification=v}},4);let Subscription;module.link("./subscription.js",{Subscription(v){Subscription=v}},5);let SubscriptionState;module.link("./subscription-state.js",{SubscriptionState(v){SubscriptionState=v}},6);
