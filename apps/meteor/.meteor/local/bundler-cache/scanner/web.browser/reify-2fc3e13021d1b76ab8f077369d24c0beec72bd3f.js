module.export({constructOutgoingResponse:()=>constructOutgoingResponse});let getReasonPhrase,newTag,utf8Length;module.link("./utils.js",{getReasonPhrase(v){getReasonPhrase=v},newTag(v){newTag=v},utf8Length(v){utf8Length=v}},0);
/**
