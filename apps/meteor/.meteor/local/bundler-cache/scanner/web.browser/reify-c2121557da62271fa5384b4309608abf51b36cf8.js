module.export({IncomingMessage:()=>IncomingMessage});let Grammar;module.link("../../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let headerize;module.link("./utils.js",{headerize(v){headerize=v}},1);
