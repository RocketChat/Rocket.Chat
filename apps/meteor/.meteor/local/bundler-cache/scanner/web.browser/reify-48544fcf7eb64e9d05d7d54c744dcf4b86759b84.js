module.export({UserAgentServer:()=>UserAgentServer});let TransactionStateError;module.link("../exceptions/transaction-state-error.js",{TransactionStateError(v){TransactionStateError=v}},0);let constructOutgoingResponse;module.link("../messages/outgoing-response.js",{constructOutgoingResponse(v){constructOutgoingResponse=v}},1);let newTag;module.link("../messages/utils.js",{newTag(v){newTag=v}},2);let InviteServerTransaction;module.link("../transactions/invite-server-transaction.js",{InviteServerTransaction(v){InviteServerTransaction=v}},3);let NonInviteServerTransaction;module.link("../transactions/non-invite-server-transaction.js",{NonInviteServerTransaction(v){NonInviteServerTransaction=v}},4);let TransactionState;module.link("../transactions/transaction-state.js",{TransactionState(v){TransactionState=v}},5);
