module.export({UserAgentServer:()=>UserAgentServer});let TransactionStateError;module.link("../exceptions",{TransactionStateError(v){TransactionStateError=v}},0);let constructOutgoingResponse;module.link("../messages",{constructOutgoingResponse(v){constructOutgoingResponse=v}},1);let newTag;module.link("../messages/utils",{newTag(v){newTag=v}},2);let InviteServerTransaction,NonInviteServerTransaction,TransactionState;module.link("../transactions",{InviteServerTransaction(v){InviteServerTransaction=v},NonInviteServerTransaction(v){NonInviteServerTransaction=v},TransactionState(v){TransactionState=v}},3);
