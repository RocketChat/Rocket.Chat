...
var ListItem = function (_a) {
    ...
    return (_jsxs(Box, __assign({ display: 'flex', is: 'li', fontScale: fontScale, color: 'inherit' }, { children: [icon && _jsx(Icon, { name: icon, color: iconColor, size: 'x16', mie: 4 }), children] })));
};
