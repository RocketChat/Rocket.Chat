module.export({Resizable:()=>Resizable});let React;module.link('react',{"*"(v){React=v}},0);let flushSync;module.link('react-dom',{flushSync(v){flushSync=v}},1);let Resizer;module.link('./resizer',{Resizer(v){Resizer=v}},2);var __extends = (this && this.__extends) || (function () {
