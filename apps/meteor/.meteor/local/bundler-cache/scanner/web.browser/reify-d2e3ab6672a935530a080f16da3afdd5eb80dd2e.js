let _jsx,_jsxs;module.link("react/jsx-runtime",{jsx(v){_jsx=v},jsxs(v){_jsxs=v}},0);let Box,Margins;module.link('@rocket.chat/fuselage',{Box(v){Box=v},Margins(v){Margins=v}},1);let BackgroundLayer,LayoutLogo;module.link('@rocket.chat/layout',{BackgroundLayer(v){BackgroundLayer=v},LayoutLogo(v){LayoutLogo=v}},2);let Trans,useTranslation;module.link('react-i18next',{Trans(v){Trans=v},useTranslation(v){useTranslation=v}},3);let EmailCodeFallback;module.link('../../common/EmailCodeFallback',{default(v){EmailCodeFallback=v}},4);var __assign = (this && this.__assign) || function () {
...
var LoginLinkEmailPage = function (_a) {
    ...
    return (_jsx(BackgroundLayer, { children: _jsx(Box, __assign({ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', width: '100%', maxWidth: 800, paddingBlock: 32, paddingInline: 16 }, { children: _jsxs(Margins, __assign({ blockEnd: 32 }, { children: [_jsx(LayoutLogo.LayoutLogo, {}), _jsx(Box, __assign({ fontScale: 'hero', width: '100%' }, { children: t('page.magicLinkEmail.title') })), _jsx(Box, __assign({ fontScale: 'p1', maxWidth: 570 }, { children: _jsx(Trans, { i18nKey: 'page.magicLinkEmail.subtitle' }) })), _jsx(EmailCodeFallback, { onResendEmailRequest: onResendEmailRequest, onChangeEmailRequest: onChangeEmailRequest })] })) })) }));
};
