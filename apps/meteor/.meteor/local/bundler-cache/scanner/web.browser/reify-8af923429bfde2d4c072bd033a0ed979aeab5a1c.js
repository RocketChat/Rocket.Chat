module.export({SSRProvider:()=>$b5e257d569688ac6$export$9f8ac96af4b1b2ae,useIsSSR:()=>$b5e257d569688ac6$export$535bd6ca7f90a273,useSSRSafeId:()=>$b5e257d569688ac6$export$619500959fc48b26});let $670gB$react,$670gB$useContext,$670gB$useState,$670gB$useMemo,$670gB$useLayoutEffect,$670gB$useRef;module.link("react",{default(v){$670gB$react=v},useContext(v){$670gB$useContext=v},useState(v){$670gB$useState=v},useMemo(v){$670gB$useMemo=v},useLayoutEffect(v){$670gB$useLayoutEffect=v},useRef(v){$670gB$useRef=v}},0);
