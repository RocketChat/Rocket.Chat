module.export({SIPExtension:()=>SIPExtension});module.export({UserAgentRegisteredOptionTags:()=>UserAgentRegisteredOptionTags},true);/**
...
})(module.runSetters(SIPExtension = SIPExtension || (module.runSetters(SIPExtension = {},["SIPExtension"])),["SIPExtension"]));
/**
 * SIP Option Tags
 * @remarks
