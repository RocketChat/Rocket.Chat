module.export({SessionDescriptionHandlerError:()=>SessionDescriptionHandlerError});let Exception;module.link("../../core/exceptions/exception.js",{Exception(v){Exception=v}},0);
/**
