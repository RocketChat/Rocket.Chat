module.export({ReInviteUserAgentServer:()=>ReInviteUserAgentServer});let InviteServerTransaction;module.link("../transactions/invite-server-transaction.js",{InviteServerTransaction(v){InviteServerTransaction=v}},0);let UserAgentServer;module.link("./user-agent-server.js",{UserAgentServer(v){UserAgentServer=v}},1);
