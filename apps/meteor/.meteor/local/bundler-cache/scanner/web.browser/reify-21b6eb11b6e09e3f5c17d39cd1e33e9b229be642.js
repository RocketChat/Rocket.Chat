module.export({Messager:()=>Messager});let Grammar;module.link("../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let C;module.link("../core/messages/methods/constants.js",{C(v){C=v}},1);
