module.export({PasswordVerifierItem:()=>PasswordVerifierItem},true);let _jsx,_jsxs;module.link("react/jsx-runtime",{jsx(v){_jsx=v},jsxs(v){_jsxs=v}},0);let Box,Icon;module.link('@rocket.chat/fuselage',{Box(v){Box=v},Icon(v){Icon=v}},1);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
