module.export({UserAgentClient:()=>UserAgentClient});let C,IncomingResponseMessage;module.link("../messages",{C(v){C=v},IncomingResponseMessage(v){IncomingResponseMessage=v}},0);let NonInviteClientTransaction,TransactionState;module.link("../transactions",{NonInviteClientTransaction(v){NonInviteClientTransaction=v},TransactionState(v){TransactionState=v}},1);
