let _jsx,_Fragment,_jsxs;module.link("react/jsx-runtime",{jsx(v){_jsx=v},Fragment(v){_Fragment=v},jsxs(v){_jsxs=v}},0);let IconButton,MenuItem,MenuSection,MenuV2;module.link('@rocket.chat/fuselage',{IconButton(v){IconButton=v},MenuItem(v){MenuItem=v},MenuSection(v){MenuSection=v},MenuV2(v){MenuV2=v}},1);let cloneElement;module.link('react',{cloneElement(v){cloneElement=v}},2);let useTranslation;module.link('react-i18next',{useTranslation(v){useTranslation=v}},3);let GenericMenuItem;module.link('./GenericMenuItem',{default(v){GenericMenuItem=v}},4);let useHandleMenuAction;module.link('./hooks/useHandleMenuAction',{useHandleMenuAction(v){useHandleMenuAction=v}},5);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
