module.export({UserAgent:()=>UserAgent});let Grammar;module.link("../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let URI;module.link("../grammar/uri.js",{URI(v){URI=v}},1);let DigestAuthentication;module.link("../core/messages/digest-authentication.js",{DigestAuthentication(v){DigestAuthentication=v}},2);let IncomingRequestMessage;module.link("../core/messages/incoming-request-message.js",{IncomingRequestMessage(v){IncomingRequestMessage=v}},3);let IncomingResponseMessage;module.link("../core/messages/incoming-response-message.js",{IncomingResponseMessage(v){IncomingResponseMessage=v}},4);let Levels;module.link("../core/log/levels.js",{Levels(v){Levels=v}},5);let LoggerFactory;module.link("../core/log/logger-factory.js",{LoggerFactory(v){LoggerFactory=v}},6);let Parser;module.link("../core/messages/parser.js",{Parser(v){Parser=v}},7);let UserAgentCore;module.link("../core/user-agent-core/user-agent-core.js",{UserAgentCore(v){UserAgentCore=v}},8);let createRandomToken,utf8Length;module.link("../core/messages/utils.js",{createRandomToken(v){createRandomToken=v},utf8Length(v){utf8Length=v}},9);let defaultSessionDescriptionHandlerFactory;module.link("../platform/web/session-description-handler/session-description-handler-factory-default.js",{defaultSessionDescriptionHandlerFactory(v){defaultSessionDescriptionHandlerFactory=v}},10);let WebTransport;module.link("../platform/web/transport/transport.js",{Transport(v){WebTransport=v}},11);let LIBRARY_VERSION;module.link("../version.js",{LIBRARY_VERSION(v){LIBRARY_VERSION=v}},12);let EmitterImpl;module.link("./emitter.js",{EmitterImpl(v){EmitterImpl=v}},13);let Invitation;module.link("./invitation.js",{Invitation(v){Invitation=v}},14);let Inviter;module.link("./inviter.js",{Inviter(v){Inviter=v}},15);let Message;module.link("./message.js",{Message(v){Message=v}},16);let Notification;module.link("./notification.js",{Notification(v){Notification=v}},17);let SIPExtension,UserAgentRegisteredOptionTags;module.link("./user-agent-options.js",{SIPExtension(v){SIPExtension=v},UserAgentRegisteredOptionTags(v){UserAgentRegisteredOptionTags=v}},18);let UserAgentState;module.link("./user-agent-state.js",{UserAgentState(v){UserAgentState=v}},19);
