...
const LoginServicesButton = (_a) => {
    ...
    return (_jsx(Button, { icon: icon, className: className, onClick: handleOnClick, title: buttonLabelText && buttonLabelText !== title ? title : undefined, disabled: disabled, alignItems: 'center', display: 'flex', justifyContent: 'center', children: buttonLabelText || t('Sign_in_with__provider__', { provider: title }) }));
};
