module.export({PublisherState:()=>PublisherState});/**
...
})(module.runSetters(PublisherState = PublisherState || (module.runSetters(PublisherState = {},["PublisherState"])),["PublisherState"]));
