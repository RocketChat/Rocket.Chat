let _jsx,_jsxs;module.link("react/jsx-runtime",{jsx(v){_jsx=v},jsxs(v){_jsxs=v}},0);let Box,Button;module.link('@rocket.chat/fuselage',{Box(v){Box=v},Button(v){Button=v}},1);let UiKit;module.link('@rocket.chat/ui-kit',{"*"(v){UiKit=v}},2);let memo,useCallback,useMemo,useState;module.link('react',{memo(v){memo=v},useCallback(v){useCallback=v},useMemo(v){useMemo=v},useState(v){useState=v}},3);let Action;module.link('./ActionsBlock.Action',{default(v){Action=v}},4);let useSurfaceType;module.link('../hooks/useSurfaceType',{useSurfaceType(v){useSurfaceType=v}},5);
