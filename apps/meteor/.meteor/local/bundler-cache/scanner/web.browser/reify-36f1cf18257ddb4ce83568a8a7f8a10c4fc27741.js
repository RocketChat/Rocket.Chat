module.export({useAnimationFrame:()=>useAnimationFrame,useAnimationFrameLoop:()=>useAnimationFrameLoop,useClock:()=>useClock,useCountdown:()=>useCountdown,useCounter:()=>useCounter,useDebounce:()=>useDebounce,useIdleCallback:()=>useIdleCallback,useIdleCallbackEffect:()=>useIdleCallbackEffect,useInterval:()=>useInterval,useThrottle:()=>useThrottle,useTimeout:()=>useTimeout,useTimeoutEffect:()=>useTimeoutEffect,useTimer:()=>useTimer});let useRef,useCallback,useEffect,useState;module.link('react',{useRef(v){useRef=v},useCallback(v){useCallback=v},useEffect(v){useEffect=v},useState(v){useState=v}},0);
...
const useIdleCallbackEffect = (effect, deps) => {
    ...
    const idleCallbackHandle = useRef(null);
    const idleCallbackFunc = useCallback((callback, options) => {
