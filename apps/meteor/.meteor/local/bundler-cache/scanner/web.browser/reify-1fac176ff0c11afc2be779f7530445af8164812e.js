module.export({fromBodyLegacy:()=>fromBodyLegacy,isBody:()=>isBody,getBody:()=>getBody});let IncomingRequestMessage;module.link("./incoming-request-message.js",{IncomingRequestMessage(v){IncomingRequestMessage=v}},0);let IncomingResponseMessage;module.link("./incoming-response-message.js",{IncomingResponseMessage(v){IncomingResponseMessage=v}},1);let OutgoingRequestMessage;module.link("./outgoing-request-message.js",{OutgoingRequestMessage(v){OutgoingRequestMessage=v}},2);
