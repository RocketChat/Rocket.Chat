let Emitter;module.link('@rocket.chat/emitter',{Emitter(v){Emitter=v}},0);let Registerer,RequestPendingError,SessionState,UserAgent,Invitation,Inviter,RegistererState,UserAgentState;module.link('sip.js',{Registerer(v){Registerer=v},RequestPendingError(v){RequestPendingError=v},SessionState(v){SessionState=v},UserAgent(v){UserAgent=v},Invitation(v){Invitation=v},Inviter(v){Inviter=v},RegistererState(v){RegistererState=v},UserAgentState(v){UserAgentState=v}},1);let SessionDescriptionHandler;module.link('sip.js/lib/platform/web',{SessionDescriptionHandler(v){SessionDescriptionHandler=v}},2);let LocalStream;module.link('./LocalStream',{default(v){LocalStream=v}},3);let RemoteStream;module.link('./RemoteStream',{default(v){RemoteStream=v}},4);var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
