module.export({SyntaxError:()=>SyntaxError});module.export({parse:()=>parse},true);let NameAddrHeader;module.link("../../name-addr-header.js",{NameAddrHeader(v){NameAddrHeader=v}},0);let URI;module.link("../../uri.js",{URI(v){URI=v}},1);
