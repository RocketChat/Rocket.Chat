module.link('./real-module.js',{"*":"*"},0);module.link('./useMessageFormatter.module.js',{"*":"*"},1);// useMessageFormatter is deprecated, but has a large dependency on intl-messageformat
