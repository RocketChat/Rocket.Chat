module.export({DigestAuthentication:()=>DigestAuthentication});let Md5;module.link("./md5.js",{Md5(v){Md5=v}},0);let createRandomToken;module.link("./utils.js",{createRandomToken(v){createRandomToken=v}},1);
