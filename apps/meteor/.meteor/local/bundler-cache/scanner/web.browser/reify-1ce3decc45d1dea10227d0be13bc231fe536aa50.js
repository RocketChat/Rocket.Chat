module.export({Dialog:()=>Dialog});let NameAddrHeader;module.link("../../grammar/name-addr-header.js",{NameAddrHeader(v){NameAddrHeader=v}},0);let C;module.link("../messages/methods/constants.js",{C(v){C=v}},1);
