module.export({UserAgentCore:()=>UserAgentCore});let C;module.link("../messages/methods/constants.js",{C(v){C=v}},0);let OutgoingRequestMessage;module.link("../messages/outgoing-request-message.js",{OutgoingRequestMessage(v){OutgoingRequestMessage=v}},1);let constructOutgoingResponse;module.link("../messages/outgoing-response.js",{constructOutgoingResponse(v){constructOutgoingResponse=v}},2);let InviteServerTransaction;module.link("../transactions/invite-server-transaction.js",{InviteServerTransaction(v){InviteServerTransaction=v}},3);let NonInviteClientTransaction;module.link("../transactions/non-invite-client-transaction.js",{NonInviteClientTransaction(v){NonInviteClientTransaction=v}},4);let TransactionState;module.link("../transactions/transaction-state.js",{TransactionState(v){TransactionState=v}},5);let InviteUserAgentClient;module.link("../user-agents/invite-user-agent-client.js",{InviteUserAgentClient(v){InviteUserAgentClient=v}},6);let InviteUserAgentServer;module.link("../user-agents/invite-user-agent-server.js",{InviteUserAgentServer(v){InviteUserAgentServer=v}},7);let MessageUserAgentClient;module.link("../user-agents/message-user-agent-client.js",{MessageUserAgentClient(v){MessageUserAgentClient=v}},8);let MessageUserAgentServer;module.link("../user-agents/message-user-agent-server.js",{MessageUserAgentServer(v){MessageUserAgentServer=v}},9);let NotifyUserAgentServer;module.link("../user-agents/notify-user-agent-server.js",{NotifyUserAgentServer(v){NotifyUserAgentServer=v}},10);let PublishUserAgentClient;module.link("../user-agents/publish-user-agent-client.js",{PublishUserAgentClient(v){PublishUserAgentClient=v}},11);let ReferUserAgentServer;module.link("../user-agents/refer-user-agent-server.js",{ReferUserAgentServer(v){ReferUserAgentServer=v}},12);let RegisterUserAgentClient;module.link("../user-agents/register-user-agent-client.js",{RegisterUserAgentClient(v){RegisterUserAgentClient=v}},13);let RegisterUserAgentServer;module.link("../user-agents/register-user-agent-server.js",{RegisterUserAgentServer(v){RegisterUserAgentServer=v}},14);let SubscribeUserAgentClient;module.link("../user-agents/subscribe-user-agent-client.js",{SubscribeUserAgentClient(v){SubscribeUserAgentClient=v}},15);let SubscribeUserAgentServer;module.link("../user-agents/subscribe-user-agent-server.js",{SubscribeUserAgentServer(v){SubscribeUserAgentServer=v}},16);let UserAgentClient;module.link("../user-agents/user-agent-client.js",{UserAgentClient(v){UserAgentClient=v}},17);let AllowedMethods;module.link("./allowed-methods.js",{AllowedMethods(v){AllowedMethods=v}},18);
