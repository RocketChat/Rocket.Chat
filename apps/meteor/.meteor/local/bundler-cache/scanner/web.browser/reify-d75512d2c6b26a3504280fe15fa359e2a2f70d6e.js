module.export({useTextField:()=>$2d73ec29415bd339$export$712718f7aec83d5,useFormattedTextField:()=>$d841c8010a73d545$export$4f384c9210e583c3});let $kOq5K$filterDOMProps,$kOq5K$mergeProps;module.link("@react-aria/utils",{filterDOMProps(v){$kOq5K$filterDOMProps=v},mergeProps(v){$kOq5K$mergeProps=v}},0);let $kOq5K$useField;module.link("@react-aria/label",{useField(v){$kOq5K$useField=v}},1);let $kOq5K$useFocusable;module.link("@react-aria/focus",{useFocusable(v){$kOq5K$useFocusable=v}},2);let $kOq5K$useRef,$kOq5K$useEffect;module.link("react",{useRef(v){$kOq5K$useRef=v},useEffect(v){$kOq5K$useEffect=v}},3);
