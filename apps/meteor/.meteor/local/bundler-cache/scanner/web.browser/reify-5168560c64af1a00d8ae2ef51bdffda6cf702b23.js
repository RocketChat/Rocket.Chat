module.export({useVoipExtensionDetails:()=>useVoipExtensionDetails},true);let useEndpoint;module.link('@rocket.chat/ui-contexts',{useEndpoint(v){useEndpoint=v}},0);let useQuery;module.link('@tanstack/react-query',{useQuery(v){useQuery=v}},1);var __rest = (this && this.__rest) || function (s, e) {
    var t = {};
