module.export({Session:()=>Session});let Grammar;module.link("../grammar/grammar.js",{Grammar(v){Grammar=v}},0);let URI;module.link("../grammar/uri.js",{URI(v){URI=v}},1);let fromBodyLegacy,getBody;module.link("../core/messages/body.js",{fromBodyLegacy(v){fromBodyLegacy=v},getBody(v){getBody=v}},2);let SessionDialogState,SignalingState;module.link("../core/session/session.js",{SessionState(v){SessionDialogState=v},SignalingState(v){SignalingState=v}},3);let getReasonPhrase;module.link("../core/messages/utils.js",{getReasonPhrase(v){getReasonPhrase=v}},4);let AllowedMethods;module.link("../core/user-agent-core/allowed-methods.js",{AllowedMethods(v){AllowedMethods=v}},5);let Ack;module.link("./ack.js",{Ack(v){Ack=v}},6);let Bye;module.link("./bye.js",{Bye(v){Bye=v}},7);let EmitterImpl;module.link("./emitter.js",{EmitterImpl(v){EmitterImpl=v}},8);let ContentTypeUnsupportedError;module.link("./exceptions/content-type-unsupported.js",{ContentTypeUnsupportedError(v){ContentTypeUnsupportedError=v}},9);let RequestPendingError;module.link("./exceptions/request-pending.js",{RequestPendingError(v){RequestPendingError=v}},10);let Info;module.link("./info.js",{Info(v){Info=v}},11);let Message;module.link("./message.js",{Message(v){Message=v}},12);let Notification;module.link("./notification.js",{Notification(v){Notification=v}},13);let Referral;module.link("./referral.js",{Referral(v){Referral=v}},14);let SessionState;module.link("./session-state.js",{SessionState(v){SessionState=v}},15);
