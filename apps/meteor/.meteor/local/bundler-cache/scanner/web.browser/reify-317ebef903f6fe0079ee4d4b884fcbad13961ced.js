module.export({useVoipContactId:()=>useVoipContactId},true);let useVoipExtensionDetails;module.link('./useVoipExtensionDetails',{useVoipExtensionDetails(v){useVoipExtensionDetails=v}},0);
