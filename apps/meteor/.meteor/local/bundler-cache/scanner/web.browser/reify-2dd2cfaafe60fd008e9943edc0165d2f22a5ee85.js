let _jsx,_Fragment;module.link("react/jsx-runtime",{jsx(v){_jsx=v},Fragment(v){_Fragment=v}},0);let lazy;module.link('react',{lazy(v){lazy=v}},1);let BoldSpan;module.link('./BoldSpan',{default(v){BoldSpan=v}},2);let ImageElement;module.link('./ImageElement',{default(v){ImageElement=v}},3);let ItalicSpan;module.link('./ItalicSpan',{default(v){ItalicSpan=v}},4);let LinkSpan;module.link('./LinkSpan',{default(v){LinkSpan=v}},5);let PlainSpan;module.link('./PlainSpan',{default(v){PlainSpan=v}},6);let StrikeSpan;module.link('./StrikeSpan',{default(v){StrikeSpan=v}},7);let Timestamp;module.link('./Timestamp',{default(v){Timestamp=v}},8);let CodeElement;module.link('../code/CodeElement',{default(v){CodeElement=v}},9);let ColorElement;module.link('../colors/ColorElement',{default(v){ColorElement=v}},10);let EmojiElement;module.link('../emoji/EmojiElement',{default(v){EmojiElement=v}},11);let KatexErrorBoundary;module.link('../katex/KatexErrorBoundary',{default(v){KatexErrorBoundary=v}},12);let ChannelMentionElement;module.link('../mentions/ChannelMentionElement',{default(v){ChannelMentionElement=v}},13);let UserMentionElement;module.link('../mentions/UserMentionElement',{default(v){UserMentionElement=v}},14);
