...
export default defineConfig(async () => {
	...
	return defineConfig({
		...
		resolve: {
			...
			alias: {
				// Meteor packages (meteor/* resolves to the workspace port of the client runtime)
				'meteor': path.resolve('../../packages/meteor-client/src'),
				'@rocket.chat/meteor-client': path.resolve('../../packages/meteor-client/src'),
				...
				'@rocket.chat/authorization/dist': path.resolve('../../packages/authorization/src'),
