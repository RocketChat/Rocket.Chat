...
- ([#33274](https://github.com/RocketChat/Rocket.Chat/pull/33274) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- <details><summary>Updated dependencies [f7a6d92ac4]:</summary>
...
- ([#33203](https://github.com/RocketChat/Rocket.Chat/pull/33203) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- <details><summary>Updated dependencies []:</summary>

  - @rocket.chat/core-typings@6.7.8
  - @rocket.chat/rest-typings@6.7.8
  ...
  - @rocket.chat/gazzodown@5.0.8
  - @rocket.chat/model-typings@0.3.15
  - @rocket.chat/ui-contexts@5.0.8
  - @rocket.chat/server-cloud-communication@0.0.2
  - @rocket.chat/fuselage-ui-kit@5.0.8
  - @rocket.chat/models@0.0.43
  - @rocket.chat/ui-theming@0.1.2
  - @rocket.chat/ui-avatar@1.0.8
  - @rocket.chat/ui-client@5.0.8
  - @rocket.chat/ui-video-conf@5.0.8
  - @rocket.chat/web-ui-registration@5.0.8
...
- ([#32926](https://github.com/RocketChat/Rocket.Chat/pull/32926) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- <details><summary>Updated dependencies []:</summary>

  - @rocket.chat/core-typings@6.7.7
  - @rocket.chat/rest-typings@6.7.7
  ...
  - @rocket.chat/gazzodown@5.0.7
  - @rocket.chat/model-typings@0.3.14
  - @rocket.chat/ui-contexts@5.0.7
  - @rocket.chat/server-cloud-communication@0.0.2
  - @rocket.chat/fuselage-ui-kit@5.0.7
  - @rocket.chat/models@0.0.42
  - @rocket.chat/ui-theming@0.1.2
  - @rocket.chat/ui-avatar@1.0.7
  - @rocket.chat/ui-client@5.0.7
  - @rocket.chat/ui-video-conf@5.0.7
  - @rocket.chat/web-ui-registration@5.0.7
...
- ([#32883](https://github.com/RocketChat/Rocket.Chat/pull/32883) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/guides/security/security-updates)

- ([#32878](https://github.com/RocketChat/Rocket.Chat/pull/32878) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/guides/security/security-updates)
...
- ([#32629](https://github.com/RocketChat/Rocket.Chat/pull/32629) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixes the supported versions problem, where in most cases the data chosen was the oldest

- <details><summary>Updated dependencies []:</summary>

  - @rocket.chat/core-typings@6.7.5
  - @rocket.chat/rest-typings@6.7.5
  ...
  - @rocket.chat/gazzodown@5.0.5
  - @rocket.chat/model-typings@0.3.12
  - @rocket.chat/ui-contexts@5.0.5
  - @rocket.chat/server-cloud-communication@0.0.2
  - @rocket.chat/fuselage-ui-kit@5.0.5
  - @rocket.chat/models@0.0.40
  - @rocket.chat/ui-theming@0.1.2
  - @rocket.chat/ui-avatar@1.0.5
  - @rocket.chat/ui-client@5.0.5
  - @rocket.chat/ui-video-conf@5.0.5
  - @rocket.chat/web-ui-registration@5.0.5
...
- ([#32442](https://github.com/RocketChat/Rocket.Chat/pull/32442) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixed an issue where translations would fallback to english some of the times.

- ([#32438](https://github.com/RocketChat/Rocket.Chat/pull/32438) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixed a language priority issue. It should now respect the following order: User Preference -> Browser Language -> Server Language

- ([#32448](https://github.com/RocketChat/Rocket.Chat/pull/32448) by [@dionisio-bot](https://github.com/dionisio-bot)) Added a new notification provider in light of the old FCM API deprecation, now you can choose to use the new provider or the old via the `Push_UseLegacy` setting
