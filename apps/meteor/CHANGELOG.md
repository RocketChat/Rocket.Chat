...
- ([#41855](https://github.com/RocketChat/Rocket.Chat/pull/41855) by [@dionisio-bot](https://github.com/dionisio-bot)) Adds per-client rate limiting to the unauthenticated sendForgotPasswordEmail method, matching the REST users.forgotPassword endpoint

- ([#41844](https://github.com/RocketChat/Rocket.Chat/pull/41844) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- ([#41863](https://github.com/RocketChat/Rocket.Chat/pull/41863) by [@dionisio-bot](https://github.com/dionisio-bot)) Replace http with serverFetch in downloadPublicImportFile to add SSRF protection

- ([#41826](https://github.com/RocketChat/Rocket.Chat/pull/41826) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixes special characters not being escaped in the visitor name shown in the Omnichannel queue side panel's message preview
...
- ([#41237](https://github.com/RocketChat/Rocket.Chat/pull/41237) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- ([#41246](https://github.com/RocketChat/Rocket.Chat/pull/41246) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- ([#41295](https://github.com/RocketChat/Rocket.Chat/pull/41295) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures the `users.CreateToken` endpoint checks for the `user-generate-access-token` permission when generating a login token for another user

- ([#41280](https://github.com/RocketChat/Rocket.Chat/pull/41280) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures room permission checks are applied consistently regardless of how the room is identified when converting a channel to a team or creating a team from an existing room

- <details><summary>Updated dependencies [c15e433d35357f365ec5768d3420cb9c302b4bc4]:</summary>
...
- ([#40919](https://github.com/RocketChat/Rocket.Chat/pull/40919) by [@dionisio-bot](https://github.com/dionisio-bot)) Escapes HTML tags in exported data

- ([#40894](https://github.com/RocketChat/Rocket.Chat/pull/40894) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- ([#40906](https://github.com/RocketChat/Rocket.Chat/pull/40906) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixes missing permission check on the `POST /api/v1/fingerprint` endpoint

- <details><summary>Updated dependencies []:</summary>

  - @rocket.chat/core-typings@8.3.6
  - @rocket.chat/rest-typings@8.3.6
  </details>
...
- ([#40770](https://github.com/RocketChat/Rocket.Chat/pull/40770) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixes the Chat Limits locking mechanism to allow bot agents to skip the lock as they aren't limited

- <details><summary>Updated dependencies []:</summary>

  - @rocket.chat/core-typings@8.3.5
  - @rocket.chat/rest-typings@8.3.5
  </details>
