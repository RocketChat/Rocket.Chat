...
- ([#41856](https://github.com/RocketChat/Rocket.Chat/pull/41856) by [@dionisio-bot](https://github.com/dionisio-bot)) Adds per-client rate limiting to the unauthenticated sendForgotPasswordEmail method, matching the REST users.forgotPassword endpoint

- ([#41849](https://github.com/RocketChat/Rocket.Chat/pull/41849) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- ([#41864](https://github.com/RocketChat/Rocket.Chat/pull/41864) by [@dionisio-bot](https://github.com/dionisio-bot)) Replace http with serverFetch in downloadPublicImportFile to add SSRF protection

- ([#41840](https://github.com/RocketChat/Rocket.Chat/pull/41840) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixes special characters not being escaped in the visitor name shown in the Omnichannel queue side panel's message preview
...
- ([#41238](https://github.com/RocketChat/Rocket.Chat/pull/41238) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- ([#41247](https://github.com/RocketChat/Rocket.Chat/pull/41247) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- ([#41296](https://github.com/RocketChat/Rocket.Chat/pull/41296) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures the `users.CreateToken` endpoint checks for the `user-generate-access-token` permission when generating a login token for another user

- ([#41288](https://github.com/RocketChat/Rocket.Chat/pull/41288) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures room permission checks are applied consistently regardless of how the room is identified when converting a channel to a team or creating a team from an existing room

- <details><summary>Updated dependencies [20d752e0e4dc1d37518c826dd2be3476a35710b3]:</summary>
...
- ([#40629](https://github.com/RocketChat/Rocket.Chat/pull/40629) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures OAuth tokens are cleaned up after user deactivation

- Bump @rocket.chat/meteor version.

- ([#40564](https://github.com/RocketChat/Rocket.Chat/pull/40564) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures that deactivated users have their login tokens cleaned up in users.deactivateidle

- ([#40541](https://github.com/RocketChat/Rocket.Chat/pull/40541) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures the Meteor method for translateMessage validates access and types

- ([#40579](https://github.com/RocketChat/Rocket.Chat/pull/40579) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures the visitor token is not present in the visitors.info response

- ([#40549](https://github.com/RocketChat/Rocket.Chat/pull/40549) by [@dionisio-bot](https://github.com/dionisio-bot)) Ensures the autotranslate.translateMessage endpoint checks for room access

- <details><summary>Updated dependencies [776d43cf33bab90c2d173d95b2f9a26e8a333dbe, e0f8b66d728498e26586ced3630f29ad8d855bc0]:</summary>

  - @rocket.chat/model-typings@2.1.4
  - @rocket.chat/models@2.1.4
  - @rocket.chat/core-typings@8.2.4
  - @rocket.chat/rest-typings@8.2.4
  </details>
...
- ([#40412](https://github.com/RocketChat/Rocket.Chat/pull/40412) by [@dionisio-bot](https://github.com/dionisio-bot)) Disables SAML login when it is set to validate signatures without the proper configuration for it

- ([#40432](https://github.com/RocketChat/Rocket.Chat/pull/40432) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixes Slack messages being incorrectly saved on import

- ([#40412](https://github.com/RocketChat/Rocket.Chat/pull/40412) by [@dionisio-bot](https://github.com/dionisio-bot)) Security Hotfix (https://docs.rocket.chat/docs/security-fixes-and-updates)

- <details><summary>Updated dependencies [f8cee749da561ae6b205cfe6c7ae53d63837eee3]:</summary>

  - @rocket.chat/model-typings@2.1.3
  - @rocket.chat/core-typings@8.2.3
  - @rocket.chat/models@2.1.3
  - @rocket.chat/i18n@2.1.1
  - @rocket.chat/rest-typings@8.2.3
  </details>
...
- <details><summary>Updated dependencies [cf5035781ad51be5046edcffbdcffa045cc28d2d]:</summary>

  - @rocket.chat/apps-engine@1.60.1
  - @rocket.chat/presence@0.2.53
  - @rocket.chat/apps@0.6.6
  - @rocket.chat/core-services@0.13.2
  - @rocket.chat/core-typings@8.2.2
  - @rocket.chat/fuselage-ui-kit@28.0.2
  - @rocket.chat/rest-typings@8.2.2
  - @rocket.chat/ui-voip@18.0.2
  ...
  - @rocket.chat/gazzodown@28.0.2
  - @rocket.chat/http-router@7.9.20
  - @rocket.chat/message-types@0.1.0
  - @rocket.chat/model-typings@2.1.2
  - @rocket.chat/ui-avatar@24.0.2
  - @rocket.chat/ui-client@28.0.2
  - @rocket.chat/ui-contexts@28.0.2
  - @rocket.chat/web-ui-registration@28.0.2
  ...
  - @rocket.chat/ui-video-conf@28.0.2
