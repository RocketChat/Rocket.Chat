...
const PrototypeContainer = () => {
	...
	const [currentScreenID, setCurrentScreenID] = useState<string>(projects[activeProject].screens[0]);
	...
	const { surface, blocks } = screens[currentScreenID]?.payload || screens[projects[activeProject].screens[0]].payload;
