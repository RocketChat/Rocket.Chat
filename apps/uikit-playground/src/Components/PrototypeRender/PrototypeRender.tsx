...
const PrototypeRender = ({
	...
	return (
		<Box height='max-content' mb='auto' className='rc-prototype-renderer'>
				...
				{blocks.map((action, id) => (
					...
					>
						<Box
							...
							`}
						>
							{glowActive && activeActions.includes(action.actionId) && <Box className='rc-prototype_action-glow' />}
