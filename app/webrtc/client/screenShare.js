...
export const ChromeScreenShare = {
	...
	installed: false,
	init() {
		this.callbacks['get-RocketChatScreenSharingExtensionVersion'] = (
			version,
		) => {
			if (version) {
				this.installed = true;
...
window.addEventListener('message', function(e) {
	...
	if (e.data === 'PermissionDeniedError') {
		if (ChromeScreenShare.callbacks.getSourceId != null) {
			return ChromeScreenShare.callbacks.getSourceId(
	...
	if (e.data.version != null) {
		ChromeScreenShare.callbacks[
			'get-RocketChatScreenSharingExtensionVersion'
		]
			&& ChromeScreenShare.callbacks[
				'get-RocketChatScreenSharingExtensionVersion'
			](e.data.version);
