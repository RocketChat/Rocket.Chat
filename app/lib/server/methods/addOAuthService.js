...
Meteor.methods({
	addOAuthService(name) {
		...
		settings.add(`Accounts_OAuth_Custom-${ name }-param_name`, 'access_token', { type: 'string', group: 'OAuth', section: `Custom OAuth: ${ name }`, i18nLabel: 'Accounts_OAuth_Custom_Param_Name', persistent: true });
