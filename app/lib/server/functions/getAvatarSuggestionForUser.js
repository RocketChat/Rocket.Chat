...
const avatarProviders = {
	...
	linkedin(user) {
		if (user.services && user.services.linkedin && user.services.linkedin.profilePicture && user.services.linkedin.profilePicture.identifiersUrl && user.services.linkedin.profilePicture.identifiersUrl[2] && settings.get('Accounts_OAuth_Linkedin')) {
			return {
				service: 'linkedin',
				url: user.services.linkedin.profilePicture.identifiersUrl[2],
			};
		}
	},
