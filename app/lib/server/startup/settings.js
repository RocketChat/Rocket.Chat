...
settings.addGroup('Rate Limiter', function() {
	...
	this.section('API Rate Limiter', function() {
		...
		this.add('API_Rate_Limit_IP_Enabled', true, { type: 'boolean' });
		this.add('API_Rate_Limit_IP_Requests_Allowed_Default', 12000, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_IP_Enabled', value: true } });
		this.add('API_Rate_Limit_IP_Interval_Time_Default', 60000, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_IP_Enabled', value: true } });

		this.add('API_Rate_Limit_User_Enabled', true, { type: 'boolean' });
		this.add('API_Rate_Limit_User_Requests_Allowed_Default', 1200, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_User_Enabled', value: true } });
		this.add('API_Rate_Limit_User_Interval_Time_Default', 60000, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_User_Enabled', value: true } });

		this.add('API_Rate_Limit_Connection_Enabled', true, { type: 'boolean' });
		this.add('API_Rate_Limit_Connection_Requests_Allowed_Default', 600, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_Connection_Enabled', value: true } });
		this.add('API_Rate_Limit_Connection_Interval_Time_Default', 60000, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_Connection_Enabled', value: true } });

		this.add('API_Rate_Limit_User_By_Endpoint_Enabled', true, { type: 'boolean' });
		this.add('API_Rate_Limit_User_By_Endpoint_Requests_Allowed_Default', 20, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_User_By_Endpoint_Enabled', value: true } });
		this.add('API_Rate_Limit_User_By_Endpoint_Interval_Time_Default', 10000, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_User_By_Endpoint_Enabled', value: true } });

		this.add('API_Rate_Limit_Connection_By_Endpoint_Enabled', true, { type: 'boolean' });
		this.add('API_Rate_Limit_Connection_By_Endpoint_Requests_Allowed_Default', 10, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_Connection_By_Endpoint_Enabled', value: true } });
		this.add('API_Rate_Limit_Connection_By_Endpoint_Interval_Time_Default', 10000, { type: 'int', enableQuery: { _id: 'API_Rate_Limit_Connection_By_Endpoint_Enabled', value: true } });
	});
});
