...
Template.accountProfile.helpers({
	...
	canSave(ret) {
		...
		if ((!!password && (password !== confirmationPassword)) || !validateEmail(email) || (!validateUsername(username) || usernameAvaliable !== true) || !validateName(realname) || !validateStatusMessage(statusText)) {
			return ret;
		}
	},
