...
Meteor.startup(function() {
	settingsRegistry.addGroup('Accounts', function() {
		const enableQueryCollectData = {
			_id: 'Block_Multiple_Failed_Logins_Enabled',
			value: true,
		};
		...
		this.section('Login_Attempts', function() {
			...
			this.add('Block_Multiple_Failed_Logins_Notify_Failed_Channel', '', {
				...
				enableQuery: [
					enableQueryCollectData,
					{
						_id: 'Block_Multiple_Failed_Logins_Notify_Failed',
						value: true,
					},
				],
			});
		...
		this.section('Login_Logs', function() {
			...
			this.add('Login_Logs_Username', false, {
				type: 'boolean',
				enableQuery: enableQueryAudit,
			});

			this.add('Login_Logs_UserAgent', false, {
				type: 'boolean',
				enableQuery: enableQueryAudit,
			});

			this.add('Login_Logs_ClientIp', false, {
				type: 'boolean',
				enableQuery: enableQueryAudit,
			});
