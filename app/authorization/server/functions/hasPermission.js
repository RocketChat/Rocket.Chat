...
export const hasAllPermissionAsync = async (userId, permissions, scope) =>
	Authorization.hasAllPermission(userId, permissions, scope);
export const hasPermissionAsync = async (userId, permissionId, scope) =>
...
export const hasAllPermission = (userId, permissions, scope) =>
