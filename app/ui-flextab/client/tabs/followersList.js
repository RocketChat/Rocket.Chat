...
Template.followersList.helpers({
	ignored() {
		const { user } = this;
...
Template.followersList.onCreated(function() {
...
Template.followersList.onRendered(function() {
	this.autorun(() => {
