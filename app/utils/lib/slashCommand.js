...
slashCommands.run = function _runningSlashCommand(
	command,
	params,
	message,
	triggerId,
	...
	if (
		...
		return slashCommands.commands[command].callback(
			command,
			params,
			message,
			triggerId,
...
slashCommands.getPreviews = function _gettingSlashCommandPreviews(
	command,
	params,
	message,
) {
	if (
		...
		const previewInfo = slashCommands.commands[command].previewer(
			command,
			params,
			message,
		);
