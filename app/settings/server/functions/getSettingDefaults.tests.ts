...
describe('getSettingDefaults', () => {
	...
	it('should return a public setting', () => {
		const setting = getSettingDefaults({ _id: 'test', value: 'test', type: 'string', public: true });
	...
	it('should return a blocked setting', () => {
		const setting = getSettingDefaults({ _id: 'test', value: 'test', type: 'string', blocked: true });
