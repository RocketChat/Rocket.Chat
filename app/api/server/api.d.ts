...
> = {
	...
	body: T extends object
		...
		(undefined extends TErrorDetails
			? {}
			: {
				details: TErrorDetails extends string
					? unknown
					: TErrorDetails;
					  });
};
...
> =
	...
	| ((
		this: ActionThis<TMethod, TPathPattern, TOptions>
	  ) => ResultFor<TMethod, TPathPattern>);
...
> = {
	[M in MethodOf<TPathPattern> as Lowercase<M>]: Operation<
	Uppercase<M>,
	TPathPattern,
	TOptions
	>;
...
declare class APIClass<TBasePath extends string = '/'> {
	...
	addRoute<TSubPathPattern extends string, TOptions extends Options>(
		...
		JoinPathPattern<TBasePath, TSubPathPattern>,
		TOptions
		>
	): void;
