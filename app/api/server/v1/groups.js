	...
	{ authRequired: true },
	{
		post() {
			...
			if (
				...
				&& !(typeof this.bodyParams.extraData === 'object')
			) {
				return API.v1.failure(
					'Body param "extraData" must be an object if provided',
				);
			}

			const readOnly =				typeof this.bodyParams.readOnly !== 'undefined'
