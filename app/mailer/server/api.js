...
export const send = ({ to, from, replyTo, subject, html, data, headers, lng = undefined }) => sendNoWrap({ to, from, replyTo, subject: replace(subject, data, lng), html: wrap(html, data, lng), headers });
