...
export class UserPresence {
	...
	run = (args: UserPresenseStreamArgs): void => {
		const payload = this.streamer.changedPayload(
			this.streamer.subscriptionName,
			args.uid,
			{ ...args, eventName: args.uid },
