...
import './omnichannelOfficeHours.html';

Template.omnichannelOfficeHours.helpers({
	days() {
...
Template.omnichannelOfficeHours.events({
...
Template.omnichannelOfficeHours.onCreated(async function() {
	this.dayVars = {
		Monday: {
