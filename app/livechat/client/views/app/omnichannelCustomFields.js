...
import './omnichannelCustomFields.html';

const CUSTOM_FIELDS_COUNT = 50;

Template.omnichannelCustomFields.helpers({
	customFields() {
...
Template.omnichannelCustomFields.events({
	...
	'click .custom-field-info'(e/* , instance*/) {
		e.preventDefault();
		FlowRouter.go('omnichannel-customfield-edit', { _id: this._id });
	},
});

Template.omnichannelCustomFields.onCreated(function() {
