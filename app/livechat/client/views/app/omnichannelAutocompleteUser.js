...
import './omnichannelAutocompleteUser.html';

Template.omnichannelAutocompleteUser.helpers({
	list() {
		return this.list;
	},
	items() {
...
Template.omnichannelAutocompleteUser.events({
	'input input'(e, t) {
...
Template.omnichannelAutocompleteUser.onRendered(function() {
...
Template.omnichannelAutocompleteUser.onCreated(function() {
