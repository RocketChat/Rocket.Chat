...
import './omnichannelLivechatTriggerAction.html';

Template.omnichannelLivechatTriggerAction.helpers({
	hiddenValue(current) {
...
Template.omnichannelLivechatTriggerAction.events({
...
Template.omnichannelLivechatTriggerAction.onCreated(function() {
