...
Template.omnichannelAgents.helpers({
	exceptionsAgents() {
...
Template.omnichannelAgents.events({
	...
	'click .user-info'(e, instance) {
		...
		instance.tabBar.setData({ label: t('Agent_Info'), icon: 'omnichannel' });
		instance.tabBar.open('omnichannel-agent-info');
	},
	/*
...
Template.omnichannelAgents.onCreated(function() {
	const instance = this;
	...
	TabBar.addButton({
		groups: ['omnichannel-agent-users'],
		id: 'omnichannel-agent-info',
