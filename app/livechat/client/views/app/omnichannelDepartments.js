...
import './omnichannelDepartments.html';
import { APIClient } from '../../../../utils/client';

Template.omnichannelDepartments.helpers({
	departments() {
...
Template.omnichannelDepartments.events({
	...
	'click .department-info'(e/* , instance*/) {
		e.preventDefault();
		FlowRouter.go('omnichannel-department-edit', { _id: this._id });
	},
...
Template.omnichannelDepartments.onCreated(function() {
	const instance = this;
