...
import './omnichannelIntegrationFacebook.html';

Template.omnichannelIntegrationFacebook.helpers({
	pages() {
...
Template.omnichannelIntegrationFacebook.onCreated(function() {
...
Template.omnichannelIntegrationFacebook.onRendered(function() {
	this.loading.set(true);
...
Template.omnichannelIntegrationFacebook.events({
