...
import './omnichannelIntegrationWebhook.html';
import { APIClient } from '../../../../../utils/client';

const getIntegrationSettingById = (settings, id) => settings.find((setting) => setting._id === id);

Template.omnichannelIntegrationWebhook.helpers({
	webhookUrl() {
...
Template.omnichannelIntegrationWebhook.onCreated(async function() {
...
Template.omnichannelIntegrationWebhook.events({
