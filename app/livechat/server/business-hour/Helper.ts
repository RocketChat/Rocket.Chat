...
export const openBusinessHourDefault = async (): Promise<void> => {
	...
	const activeBusinessHours =		await LivechatBusinessHours.findDefaultActiveAndOpenBusinessHoursByDay(
		day,
		{
			fields: {
				workHours: 1,
	...
	const businessHoursToOpenIds = (
		await filterBusinessHoursThatMustBeOpened(activeBusinessHours)
