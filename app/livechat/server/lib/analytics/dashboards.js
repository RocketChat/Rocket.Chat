...
const findAllChatsStatusAsync = async ({
	...
	return {
		...
		onhold: await LivechatRooms.getOnHoldConversationsBetweenDate(
			start,
			end,
			departmentId,
		),
...
const getChatsMetricsAsync = async ({
	...
	const totalOfAverageAbandonedRooms =		totalOfAbandonedRooms === 0
		? 0
		: sumOfPercentageOfAbandonedRooms / totalOfAbandonedRooms;
	const totalOfAverageChatDurationTime =		totalOfChatDurationTime === 0
		? 0
...
export const getProductivityMetrics = ({
	...
	Promise.await(
		getProductivityMetricsAsync({ start, end, departmentId, user }),
	);
export const getAgentsProductivityMetrics = ({
	...
	Promise.await(
		getAgentsProductivityMetricsAsync({ start, end, departmentId, user }),
	);
export const getConversationsMetrics = ({
	...
	Promise.await(
		getConversationsMetricsAsync({ start, end, departmentId, user }),
	);
