...
Meteor.startup(function() {
	settingsRegistry.addGroup('Omnichannel', function() {
		...
		this.add('Omnichannel_call_provider', 'none', {
			...
			alert: 'The WebRTC provider is currently in alpha!<br/>We recommend using Firefox Browser for this feature since there are some known bugs within other browsers which still needs to be fixed.<br/>Please report bugs to github.com/RocketChat/Rocket.Chat/issues',
			enableQuery: omnichannelEnabledQuery,
		});
	});
});
