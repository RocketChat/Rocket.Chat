module.export({SubscribeUserAgentClient:function(){return SubscribeUserAgentClient}});var SubscriptionDialog;module.link("../dialogs/subscription-dialog",{SubscriptionDialog:function(v){SubscriptionDialog=v}},0);var SubscriptionState;module.link("../subscription",{SubscriptionState:function(v){SubscriptionState=v}},1);var Timers;module.link("../timers",{Timers:function(v){Timers=v}},2);var NonInviteClientTransaction;module.link("../transactions",{NonInviteClientTransaction:function(v){NonInviteClientTransaction=v}},3);var UserAgentClient;module.link("./user-agent-client",{UserAgentClient:function(v){UserAgentClient=v}},4);
