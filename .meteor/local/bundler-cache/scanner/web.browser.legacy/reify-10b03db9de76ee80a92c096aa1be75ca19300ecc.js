...
var AdminInfoForm = function (_a) {
    ...
    var companyEmailField = fuselage_hooks_1.useUniqueId();
    ...
    return (jsx_runtime_1.jsxs(Form_1.default, __assign({ onSubmit: handleSubmit(onSubmit) }, { children: [jsx_runtime_1.jsx(Form_1.default.Steps, { currentStep: currentStep, stepCount: stepCount }, void 0), jsx_runtime_1.jsx(Form_1.default.Title, { children: t('form.adminInfoForm.title') }, void 0), jsx_runtime_1.jsx(Form_1.default.Subtitle, { children: t('form.adminInfoForm.subtitle') }, void 0), jsx_runtime_1.jsx(Form_1.default.Container, { children: jsx_runtime_1.jsxs(fuselage_1.FieldGroup, { children: [jsx_runtime_1.jsxs(fuselage_1.Field, { children: [jsx_runtime_1.jsx(fuselage_1.Field.Label, __assign({ htmlFor: fullnameField }, { children: t('form.adminInfoForm.fields.fullName.placeholder') }), void 0), jsx_runtime_1.jsx(fuselage_1.Field.Row, { children: jsx_runtime_1.jsx(fuselage_1.TextInput, __assign({}, register('fullname', {
                                    ...
                                    }), { placeholder: t('form.adminInfoForm.fields.username.placeholder'), id: usernameField }), void 0) }, void 0), errors.username && (jsx_runtime_1.jsx(fuselage_1.Field.Error, { children: errors.username.message }, void 0))] }, void 0), jsx_runtime_1.jsxs(fuselage_1.Field, { children: [jsx_runtime_1.jsx(fuselage_1.Field.Label, __assign({ htmlFor: companyEmailField }, { children: t('form.adminInfoForm.fields.companyEmail.label') }), void 0), jsx_runtime_1.jsx(fuselage_1.Field.Row, { children: jsx_runtime_1.jsx(fuselage_1.EmailInput, __assign({}, register('companyEmail', {
                                        required: String(t('component.form.requiredField')),
                                        validate: validateEmail,
                                    }), { placeholder: t('form.adminInfoForm.fields.companyEmail.placeholder'), id: companyEmailField }), void 0) }, void 0), errors.companyEmail && (jsx_runtime_1.jsx(fuselage_1.Field.Error, { children: errors.companyEmail.message }, void 0))] }, void 0), jsx_runtime_1.jsxs(fuselage_1.Field, { children: [jsx_runtime_1.jsx(fuselage_1.Field.Label, __assign({ htmlFor: passwordField }, { children: t('form.adminInfoForm.fields.password.label') }), void 0), jsx_runtime_1.jsx(fuselage_1.Field.Row, { children: jsx_runtime_1.jsx(fuselage_1.PasswordInput, __assign({}, register('password', {
                                        required: String(t('component.form.requiredField')),
