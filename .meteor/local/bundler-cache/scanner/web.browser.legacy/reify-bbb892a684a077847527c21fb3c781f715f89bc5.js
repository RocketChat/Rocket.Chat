module.export({SessionDialog:function(){return SessionDialog}});var C,getBody,IncomingRequestMessage,IncomingResponseMessage,isBody,NameAddrHeader,OutgoingRequestMessage;module.link("../messages",{C:function(v){C=v},getBody:function(v){getBody=v},IncomingRequestMessage:function(v){IncomingRequestMessage=v},IncomingResponseMessage:function(v){IncomingResponseMessage=v},isBody:function(v){isBody=v},NameAddrHeader:function(v){NameAddrHeader=v},OutgoingRequestMessage:function(v){OutgoingRequestMessage=v}},0);var SessionState,SignalingState;module.link("../session",{SessionState:function(v){SessionState=v},SignalingState:function(v){SignalingState=v}},1);var Timers;module.link("../timers",{Timers:function(v){Timers=v}},2);var InviteClientTransaction,InviteServerTransaction,TransactionState;module.link("../transactions",{InviteClientTransaction:function(v){InviteClientTransaction=v},InviteServerTransaction:function(v){InviteServerTransaction=v},TransactionState:function(v){TransactionState=v}},3);var ByeUserAgentClient;module.link("../user-agents/bye-user-agent-client",{ByeUserAgentClient:function(v){ByeUserAgentClient=v}},4);var ByeUserAgentServer;module.link("../user-agents/bye-user-agent-server",{ByeUserAgentServer:function(v){ByeUserAgentServer=v}},5);var InfoUserAgentClient;module.link("../user-agents/info-user-agent-client",{InfoUserAgentClient:function(v){InfoUserAgentClient=v}},6);var InfoUserAgentServer;module.link("../user-agents/info-user-agent-server",{InfoUserAgentServer:function(v){InfoUserAgentServer=v}},7);var MessageUserAgentClient;module.link("../user-agents/message-user-agent-client",{MessageUserAgentClient:function(v){MessageUserAgentClient=v}},8);var MessageUserAgentServer;module.link("../user-agents/message-user-agent-server",{MessageUserAgentServer:function(v){MessageUserAgentServer=v}},9);var NotifyUserAgentClient;module.link("../user-agents/notify-user-agent-client",{NotifyUserAgentClient:function(v){NotifyUserAgentClient=v}},10);var NotifyUserAgentServer;module.link("../user-agents/notify-user-agent-server",{NotifyUserAgentServer:function(v){NotifyUserAgentServer=v}},11);var PrackUserAgentClient;module.link("../user-agents/prack-user-agent-client",{PrackUserAgentClient:function(v){PrackUserAgentClient=v}},12);var PrackUserAgentServer;module.link("../user-agents/prack-user-agent-server",{PrackUserAgentServer:function(v){PrackUserAgentServer=v}},13);var ReInviteUserAgentClient;module.link("../user-agents/re-invite-user-agent-client",{ReInviteUserAgentClient:function(v){ReInviteUserAgentClient=v}},14);var ReInviteUserAgentServer;module.link("../user-agents/re-invite-user-agent-server",{ReInviteUserAgentServer:function(v){ReInviteUserAgentServer=v}},15);var ReferUserAgentClient;module.link("../user-agents/refer-user-agent-client",{ReferUserAgentClient:function(v){ReferUserAgentClient=v}},16);var ReferUserAgentServer;module.link("../user-agents/refer-user-agent-server",{ReferUserAgentServer:function(v){ReferUserAgentServer=v}},17);var Dialog;module.link("./dialog",{Dialog:function(v){Dialog=v}},18);
