module.export({SubscriptionDialog:function(){return SubscriptionDialog}});var C,NameAddrHeader;module.link("../messages",{C:function(v){C=v},NameAddrHeader:function(v){NameAddrHeader=v}},0);var SubscriptionState;module.link("../subscription",{SubscriptionState:function(v){SubscriptionState=v}},1);var Timers;module.link("../timers",{Timers:function(v){Timers=v}},2);var AllowedMethods;module.link("../user-agent-core/allowed-methods",{AllowedMethods:function(v){AllowedMethods=v}},3);var NotifyUserAgentServer;module.link("../user-agents/notify-user-agent-server",{NotifyUserAgentServer:function(v){NotifyUserAgentServer=v}},4);var ReSubscribeUserAgentClient;module.link("../user-agents/re-subscribe-user-agent-client",{ReSubscribeUserAgentClient:function(v){ReSubscribeUserAgentClient=v}},5);var Dialog;module.link("./dialog",{Dialog:function(v){Dialog=v}},6);
