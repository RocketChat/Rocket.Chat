module.export({ReInviteUserAgentClient:function(){return ReInviteUserAgentClient}});var C;module.link("../messages",{C:function(v){C=v}},0);var InviteClientTransaction;module.link("../transactions",{InviteClientTransaction:function(v){InviteClientTransaction=v}},1);var UserAgentClient;module.link("./user-agent-client",{UserAgentClient:function(v){UserAgentClient=v}},2);
