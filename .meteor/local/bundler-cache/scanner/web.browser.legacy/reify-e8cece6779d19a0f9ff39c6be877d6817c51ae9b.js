module.export({Registerer:function(){return Registerer}});var C,Grammar,URI,equivalentURI;module.link("../core",{C:function(v){C=v},Grammar:function(v){Grammar=v},URI:function(v){URI=v},equivalentURI:function(v){equivalentURI=v}},0);var EmitterImpl;module.link("./emitter",{EmitterImpl:function(v){EmitterImpl=v}},1);var RequestPendingError;module.link("./exceptions",{RequestPendingError:function(v){RequestPendingError=v}},2);var RegistererState;module.link("./registerer-state",{RegistererState:function(v){RegistererState=v}},3);
