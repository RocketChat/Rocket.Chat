module.export({Invitation:function(){return Invitation}});var fromBodyLegacy,getBody,Grammar,SignalingState,Timers,TransactionStateError;module.link("../core",{fromBodyLegacy:function(v){fromBodyLegacy=v},getBody:function(v){getBody=v},Grammar:function(v){Grammar=v},SignalingState:function(v){SignalingState=v},Timers:function(v){Timers=v},TransactionStateError:function(v){TransactionStateError=v}},0);var getReasonPhrase;module.link("../core/messages/utils",{getReasonPhrase:function(v){getReasonPhrase=v}},1);var ContentTypeUnsupportedError,SessionDescriptionHandlerError,SessionTerminatedError;module.link("./exceptions",{ContentTypeUnsupportedError:function(v){ContentTypeUnsupportedError=v},SessionDescriptionHandlerError:function(v){SessionDescriptionHandlerError=v},SessionTerminatedError:function(v){SessionTerminatedError=v}},2);var Session;module.link("./session",{Session:function(v){Session=v}},3);var SessionState;module.link("./session-state",{SessionState:function(v){SessionState=v}},4);var SIPExtension;module.link("./user-agent-options",{SIPExtension:function(v){SIPExtension=v}},5);
