module.export({UserAgentClient:function(){return UserAgentClient}});var C,IncomingResponseMessage;module.link("../messages",{C:function(v){C=v},IncomingResponseMessage:function(v){IncomingResponseMessage=v}},0);var NonInviteClientTransaction,TransactionState;module.link("../transactions",{NonInviteClientTransaction:function(v){NonInviteClientTransaction=v},TransactionState:function(v){TransactionState=v}},1);
