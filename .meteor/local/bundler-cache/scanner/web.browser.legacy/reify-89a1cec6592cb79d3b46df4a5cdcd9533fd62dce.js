module.export({SyntaxError:function(){return SyntaxError}});module.export({parse:function(){return parse}},true);var NameAddrHeader;module.link("../../name-addr-header",{NameAddrHeader:function(v){NameAddrHeader=v}},0);var URI;module.link("../../uri",{URI:function(v){URI=v}},1);
