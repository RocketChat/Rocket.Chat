module.export({Inviter:function(){return Inviter}});var C,Grammar,SignalingState;module.link("../core",{C:function(v){C=v},Grammar:function(v){Grammar=v},SignalingState:function(v){SignalingState=v}},0);var getReasonPhrase,newTag;module.link("../core/messages/utils",{getReasonPhrase:function(v){getReasonPhrase=v},newTag:function(v){newTag=v}},1);var Session;module.link("./session",{Session:function(v){Session=v}},2);var SessionState;module.link("./session-state",{SessionState:function(v){SessionState=v}},3);var SIPExtension;module.link("./user-agent-options",{SIPExtension:function(v){SIPExtension=v}},4);
