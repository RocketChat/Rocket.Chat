module.export({SimpleUser:()=>SimpleUser});let Invitation,Inviter,Messager,Registerer,RegistererState,RequestPendingError,SessionState,UserAgent,UserAgentState;module.link("../../../api",{Invitation(v){Invitation=v},Inviter(v){Inviter=v},Messager(v){Messager=v},Registerer(v){Registerer=v},RegistererState(v){RegistererState=v},RequestPendingError(v){RequestPendingError=v},SessionState(v){SessionState=v},UserAgent(v){UserAgent=v},UserAgentState(v){UserAgentState=v}},0);let SessionDescriptionHandler;module.link("../session-description-handler",{SessionDescriptionHandler(v){SessionDescriptionHandler=v}},1);let Transport;module.link("../transport",{Transport(v){Transport=v}},2);
