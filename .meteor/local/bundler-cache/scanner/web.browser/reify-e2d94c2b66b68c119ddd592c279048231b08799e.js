module.export({defaults:()=>defaults,ellipsis:()=>ellipsis,indexOf:()=>indexOf,remove:()=>remove,splitAndCapture:()=>splitAndCapture,throwUnhandledCaseError:()=>throwUnhandledCaseError});/**
