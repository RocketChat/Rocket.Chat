...
var useUiKitState = function (rest, context) {
    var blockId = rest.blockId, actionId = rest.actionId, appId = rest.appId;
    ...
    var actionFunction = useMutableCallback(function (_a) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, state({ blockId: blockId, appId: appId, actionId: actionId, value: value, viewId: viewId })];
                    case 1:
                        _b = (_c.sent());
                        _c.label = 2;
                    case 2:
    ...
    var stateFunction = useMutableCallback(function (_a) {
        var value = _a.target.value;
        return __awaiter(void 0, void 0, void 0, function () {
