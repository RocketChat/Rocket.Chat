module.export({Axes:()=>Axes$1,Axis:()=>Axis$1,Grid:()=>Grid$1,axisPropType:()=>axisPropType,axisPropTypes:()=>axisPropTypes,renderAxesToCanvas:()=>renderAxesToCanvas,renderAxisToCanvas:()=>renderAxisToCanvas,renderGridLinesToCanvas:()=>renderGridLinesToCanvas});let React,memo,useMemo,Fragment;module.link('react',{default(v){React=v},memo(v){memo=v},useMemo(v){useMemo=v},Fragment(v){Fragment=v}},0);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},1);let Motion,spring,TransitionMotion;module.link('react-motion',{Motion(v){Motion=v},spring(v){spring=v},TransitionMotion(v){TransitionMotion=v}},2);let textPropsByEngine,useTheme,useMotionConfig;module.link('@nivo/core',{textPropsByEngine(v){textPropsByEngine=v},useTheme(v){useTheme=v},useMotionConfig(v){useMotionConfig=v}},3);let isNumber;module.link('lodash/isNumber',{default(v){isNumber=v}},4);let timeMillisecond,utcMillisecond,timeSecond,utcSecond,timeMinute,utcMinute,timeHour,utcHour,timeDay,utcDay,timeWeek,utcWeek,timeSunday,utcSunday,timeMonday,utcMonday,timeTuesday,utcTuesday,timeWednesday,utcWednesday,timeThursday,utcThursday,timeFriday,utcFriday,timeSaturday,utcSaturday,timeMonth,utcMonth,timeYear,utcYear;module.link('d3-time',{timeMillisecond(v){timeMillisecond=v},utcMillisecond(v){utcMillisecond=v},timeSecond(v){timeSecond=v},utcSecond(v){utcSecond=v},timeMinute(v){timeMinute=v},utcMinute(v){utcMinute=v},timeHour(v){timeHour=v},utcHour(v){utcHour=v},timeDay(v){timeDay=v},utcDay(v){utcDay=v},timeWeek(v){timeWeek=v},utcWeek(v){utcWeek=v},timeSunday(v){timeSunday=v},utcSunday(v){utcSunday=v},timeMonday(v){timeMonday=v},utcMonday(v){utcMonday=v},timeTuesday(v){timeTuesday=v},utcTuesday(v){utcTuesday=v},timeWednesday(v){timeWednesday=v},utcWednesday(v){utcWednesday=v},timeThursday(v){timeThursday=v},utcThursday(v){utcThursday=v},timeFriday(v){timeFriday=v},utcFriday(v){utcFriday=v},timeSaturday(v){timeSaturday=v},utcSaturday(v){utcSaturday=v},timeMonth(v){timeMonth=v},utcMonth(v){utcMonth=v},timeYear(v){timeYear=v},utcYear(v){utcYear=v}},5);let timeFormat;module.link('d3-time-format',{timeFormat(v){timeFormat=v}},6);let format;module.link('d3-format',{format(v){format=v}},7);
