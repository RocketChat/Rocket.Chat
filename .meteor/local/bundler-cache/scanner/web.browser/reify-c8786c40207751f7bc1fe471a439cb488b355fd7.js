...
var OrganizationInfoPage = function (_a) {
    ...
    return (_jsx(BackgroundLayer, { children: _jsx(FormPageLayout, __assign({ styleProps: pageLayoutStyleProps, title: title || t('page.organizationInfoPage.title'), description: description, subtitle: t('page.organizationInfoPage.subtitle') }, { children: _jsx(OrganizationInfoForm, __assign({}, props), void 0) }), void 0) }, void 0));
};
