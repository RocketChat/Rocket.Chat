module.export({BoxLegendSvg:()=>BoxLegendSvg,LegendPropShape:()=>LegendPropShape,LegendSvg:()=>LegendSvg,LegendSvgItem:()=>LegendSvgItem,renderLegendToCanvas:()=>renderLegendToCanvas,useQuantizeColorScaleLegendData:()=>useQuantizeColorScaleLegendData});let useState,useCallback,createElement,useMemo;module.link('react',{useState(v){useState=v},useCallback(v){useCallback=v},createElement(v){createElement=v},useMemo(v){useMemo=v}},0);let useTheme;module.link('@nivo/core',{useTheme(v){useTheme=v}},1);let jsx,jsxs;module.link('react/jsx-runtime',{jsx(v){jsx=v},jsxs(v){jsxs=v}},2);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},3);
