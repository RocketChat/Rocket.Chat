module.export({Publisher:()=>Publisher});let C,fromBodyLegacy;module.link("../core",{C(v){C=v},fromBodyLegacy(v){fromBodyLegacy=v}},0);let EmitterImpl;module.link("./emitter",{EmitterImpl(v){EmitterImpl=v}},1);let PublisherState;module.link("./publisher-state",{PublisherState(v){PublisherState=v}},2);
