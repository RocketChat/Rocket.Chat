...
var CheckYourEmailPage = function (_a) {
    ...
    return (_jsx(BackgroundLayer, { children: _jsx(Box, __assign({ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', width: '100%', maxWidth: 576, paddingBlock: 32, paddingInline: 16 }, { children: _jsxs(Margins, __assign({ blockEnd: 32 }, { children: [_jsx(OnboardingLogo, {}, void 0), _jsx(Box, __assign({ fontWeight: 800, fontSize: 'x52', lineHeight: 'x62', fontFamily: 'sans' }, { children: t('page.checkYourEmail.title') }), void 0), _jsx(Box, __assign({ fontScale: 'p1' }, { children: _jsxs(Trans, __assign({ i18nKey: 'page.checkYourEmail.subtitle' }, { children: ["Your request has been sent successfully.", _jsx("br", {}, void 0), "Check your email inbox to launch your Enterprise trial."] }), void 0) }), void 0), _jsx(EmailCodeFallback, { onResendEmailRequest: onResendEmailRequest, onChangeEmailRequest: onChangeEmailRequest }, void 0)] }), void 0) }), void 0) }, void 0));
};
