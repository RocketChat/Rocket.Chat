module.export({UrlMatcher:()=>UrlMatcher});let __extends;module.link("tslib",{__extends(v){__extends=v}},0);let Matcher;module.link('./matcher',{Matcher(v){Matcher=v}},1);let alphaNumericCharsStr,alphaNumericAndMarksCharsStr,getDomainNameStr;module.link('../regex-lib',{alphaNumericCharsStr(v){alphaNumericCharsStr=v},alphaNumericAndMarksCharsStr(v){alphaNumericAndMarksCharsStr=v},getDomainNameStr(v){getDomainNameStr=v}},2);let tldRegex;module.link('./tld-regex',{tldRegex(v){tldRegex=v}},3);let UrlMatch;module.link('../match/url-match',{UrlMatch(v){UrlMatch=v}},4);let UrlMatchValidator;module.link('./url-match-validator',{UrlMatchValidator(v){UrlMatchValidator=v}},5);
