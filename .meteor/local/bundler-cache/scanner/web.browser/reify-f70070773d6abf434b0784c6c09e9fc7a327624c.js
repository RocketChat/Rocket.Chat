module.export({compareDateValues:()=>compareDateValues,compareValues:()=>compareValues,computeScale:()=>computeScale,computeXYScalesForSeries:()=>computeXYScalesForSeries,createBandScale:()=>createBandScale,createDateNormalizer:()=>createDateNormalizer,createLinearScale:()=>createLinearScale,createLogScale:()=>createLogScale,createPointScale:()=>createPointScale,createPrecisionMethod:()=>createPrecisionMethod,createSymlogScale:()=>createSymlogScale,createTimeScale:()=>createTimeScale,generateSeriesAxis:()=>generateSeriesAxis,generateSeriesXY:()=>generateSeriesXY,getOtherAxis:()=>getOtherAxis,precisionCutOffs:()=>precisionCutOffs,precisionCutOffsByType:()=>precisionCutOffsByType,stackAxis:()=>stackAxis,timePrecisions:()=>timePrecisions});let uniq;module.link('lodash/uniq',{default(v){uniq=v}},0);let uniqBy;module.link('lodash/uniqBy',{default(v){uniqBy=v}},1);let sortBy;module.link('lodash/sortBy',{default(v){sortBy=v}},2);let last;module.link('lodash/last',{default(v){last=v}},3);let isDate;module.link('lodash/isDate',{default(v){isDate=v}},4);let utcParse,timeParse;module.link('d3-time-format',{utcParse(v){utcParse=v},timeParse(v){timeParse=v}},5);let scaleLinear,scalePoint,scaleBand,scaleUtc,scaleTime,scaleLog,scaleSymlog;module.link('d3-scale',{scaleLinear(v){scaleLinear=v},scalePoint(v){scalePoint=v},scaleBand(v){scaleBand=v},scaleUtc(v){scaleUtc=v},scaleTime(v){scaleTime=v},scaleLog(v){scaleLog=v},scaleSymlog(v){scaleSymlog=v}},6);
