module.export({NonInviteClientTransaction:()=>NonInviteClientTransaction});let Timers;module.link("../timers",{Timers(v){Timers=v}},0);let ClientTransaction;module.link("./client-transaction",{ClientTransaction(v){ClientTransaction=v}},1);let TransactionState;module.link("./transaction-state",{TransactionState(v){TransactionState=v}},2);
