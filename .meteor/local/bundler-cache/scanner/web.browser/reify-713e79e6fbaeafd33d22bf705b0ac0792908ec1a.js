module.export({useQueries:()=>useQueries});let React;module.link('react',{default(v){React=v}},0);let notifyManager;module.link('../core/notifyManager',{notifyManager(v){notifyManager=v}},1);let QueriesObserver;module.link('../core/queriesObserver',{QueriesObserver(v){QueriesObserver=v}},2);let useQueryClient;module.link('./QueryClientProvider',{useQueryClient(v){useQueryClient=v}},3);
