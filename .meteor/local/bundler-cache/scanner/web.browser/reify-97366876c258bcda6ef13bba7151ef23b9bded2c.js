module.export({default:()=>formatRelative});let getDefaultOptions;module.link("../_lib/defaultOptions/index.js",{getDefaultOptions(v){getDefaultOptions=v}},0);let differenceInCalendarDays;module.link("../differenceInCalendarDays/index.js",{default(v){differenceInCalendarDays=v}},1);let format;module.link("../format/index.js",{default(v){format=v}},2);let defaultLocale;module.link("../_lib/defaultLocale/index.js",{default(v){defaultLocale=v}},3);let subMilliseconds;module.link("../subMilliseconds/index.js",{default(v){subMilliseconds=v}},4);let toDate;module.link("../toDate/index.js",{default(v){toDate=v}},5);let getTimezoneOffsetInMilliseconds;module.link("../_lib/getTimezoneOffsetInMilliseconds/index.js",{default(v){getTimezoneOffsetInMilliseconds=v}},6);let requiredArgs;module.link("../_lib/requiredArgs/index.js",{default(v){requiredArgs=v}},7);let toInteger;module.link("../_lib/toInteger/index.js",{default(v){toInteger=v}},8);
