module.export({OutgoingRequestMessage:()=>OutgoingRequestMessage});let NameAddrHeader;module.link("../../grammar",{NameAddrHeader(v){NameAddrHeader=v}},0);let createRandomToken,headerize,newTag,utf8Length;module.link("./utils",{createRandomToken(v){createRandomToken=v},headerize(v){headerize=v},newTag(v){newTag=v},utf8Length(v){utf8Length=v}},1);
