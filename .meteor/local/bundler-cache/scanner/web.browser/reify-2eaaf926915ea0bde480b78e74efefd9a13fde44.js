module.export({URI:()=>URI,equivalentURI:()=>equivalentURI});let Parameters;module.link("./parameters",{Parameters(v){Parameters=v}},0);/* eslint-disable @typescript-eslint/no-explicit-any */
