module.export({letterRe:()=>letterRe,digitRe:()=>digitRe,nonDigitRe:()=>nonDigitRe,whitespaceRe:()=>whitespaceRe,quoteRe:()=>quoteRe,controlCharsRe:()=>controlCharsRe,alphaCharsStr:()=>alphaCharsStr,emojiStr:()=>emojiStr,marksStr:()=>marksStr,alphaCharsAndMarksStr:()=>alphaCharsAndMarksStr,decimalNumbersStr:()=>decimalNumbersStr,alphaNumericCharsStr:()=>alphaNumericCharsStr,alphaNumericAndMarksCharsStr:()=>alphaNumericAndMarksCharsStr,getDomainNameStr:()=>getDomainNameStr,domainNameRegex:()=>domainNameRegex,domainNameCharRegex:()=>domainNameCharRegex});/*
