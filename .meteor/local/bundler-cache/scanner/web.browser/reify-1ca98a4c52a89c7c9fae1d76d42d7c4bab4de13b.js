...
var ResetPasswordPage = function (_a) {
    ...
    return (_jsx(BackgroundLayer, { children: _jsxs(FormPageLayout, __assign({ title: t('page.resetPasswordPage.title'), styleProps: pageLayoutStyleProps }, { children: [_jsx(ResetPasswordForm, __assign({}, props), void 0), _jsx(Box, __assign({ fontScale: 'p2', pbs: 'x40' }, { children: _jsxs(Trans, __assign({ i18nKey: 'component.wantToLogin' }, { children: ["Want to log in?", _jsx(ActionLink, __assign({ fontScale: 'p2', onClick: onLogin }, { children: "Go to login" }), void 0)] }), void 0) }), void 0)] }), void 0) }, void 0));
};
