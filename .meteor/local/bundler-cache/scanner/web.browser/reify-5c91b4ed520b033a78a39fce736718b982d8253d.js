module.export({withContentRect:()=>withContentRect});let _extends;module.link('@babel/runtime/helpers/esm/extends',{default(v){_extends=v}},0);let _objectWithoutPropertiesLoose;module.link('@babel/runtime/helpers/esm/objectWithoutPropertiesLoose',{default(v){_objectWithoutPropertiesLoose=v}},1);let _inheritsLoose;module.link('@babel/runtime/helpers/esm/inheritsLoose',{default(v){_inheritsLoose=v}},2);let Component,createElement;module.link('react',{Component(v){Component=v},createElement(v){createElement=v}},3);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},4);let ResizeObserver;module.link('resize-observer-polyfill',{default(v){ResizeObserver=v}},5);
