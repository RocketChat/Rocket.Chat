module.export({Annotation:()=>Annotation,bindAnnotations:()=>bindAnnotations,computeAnnotation:()=>computeAnnotation,defaultProps:()=>defaultProps,getLinkAngle:()=>getLinkAngle,isCanvasNote:()=>isCanvasNote,isCircleAnnotation:()=>isCircleAnnotation,isDotAnnotation:()=>isDotAnnotation,isRectAnnotation:()=>isRectAnnotation,isSvgNote:()=>isSvgNote,renderAnnotationsToCanvas:()=>renderAnnotationsToCanvas,useAnnotations:()=>useAnnotations,useComputedAnnotation:()=>useComputedAnnotation,useComputedAnnotations:()=>useComputedAnnotations});let isValidElement,useMemo,createElement;module.link('react',{isValidElement(v){isValidElement=v},useMemo(v){useMemo=v},createElement(v){createElement=v}},0);let _omit;module.link('lodash/omit',{default(v){_omit=v}},1);let _isNumber;module.link('lodash/isNumber',{default(v){_isNumber=v}},2);let _filter;module.link('lodash/filter',{default(v){_filter=v}},3);let absoluteAngleDegrees,radiansToDegrees,positionFromAngle,degreesToRadians,useTheme,useMotionConfig,useAnimatedPath;module.link('@nivo/core',{absoluteAngleDegrees(v){absoluteAngleDegrees=v},radiansToDegrees(v){radiansToDegrees=v},positionFromAngle(v){positionFromAngle=v},degreesToRadians(v){degreesToRadians=v},useTheme(v){useTheme=v},useMotionConfig(v){useMotionConfig=v},useAnimatedPath(v){useAnimatedPath=v}},4);let useSpring,animated;module.link('@react-spring/web',{useSpring(v){useSpring=v},animated(v){animated=v}},5);let jsxs,Fragment,jsx;module.link('react/jsx-runtime',{jsxs(v){jsxs=v},Fragment(v){Fragment=v},jsx(v){jsx=v}},6);
