module.export({fromBodyLegacy:()=>fromBodyLegacy,isBody:()=>isBody,getBody:()=>getBody});let IncomingRequestMessage;module.link("./incoming-request-message",{IncomingRequestMessage(v){IncomingRequestMessage=v}},0);let IncomingResponseMessage;module.link("./incoming-response-message",{IncomingResponseMessage(v){IncomingResponseMessage=v}},1);let OutgoingRequestMessage;module.link("./outgoing-request-message",{OutgoingRequestMessage(v){OutgoingRequestMessage=v}},2);
