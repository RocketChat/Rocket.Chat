module.export({compose:()=>compose,defaultProps:()=>defaultProps,getDisplayName:()=>getDisplayName,pure:()=>pure,setDisplayName:()=>setDisplayName,setPropTypes:()=>setPropTypes,setStatic:()=>setStatic,shallowEqual:()=>shallowEqual,shouldUpdate:()=>shouldUpdate,withProps:()=>withProps,withPropsOnChange:()=>withPropsOnChange,withState:()=>withState,wrapDisplayName:()=>wrapDisplayName});let createFactory,Component;module.link('react',{createFactory(v){createFactory=v},Component(v){Component=v}},0);let polyfill;module.link('react-lifecycles-compat',{polyfill(v){polyfill=v}},1);
