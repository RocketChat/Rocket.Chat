module.export({compareDateValues:()=>compareDateValues,compareValues:()=>compareValues,computeAxisSlices:()=>computeAxisSlices,computeScale:()=>computeScale,computeXSlices:()=>computeXSlices,computeXYScalesForSeries:()=>computeXYScalesForSeries,computeYSlices:()=>computeYSlices,generateSeriesAxis:()=>generateSeriesAxis,generateSeriesXY:()=>generateSeriesXY,getOtherAxis:()=>getOtherAxis,linearScale:()=>linearScale,linearScalePropTypes:()=>linearScalePropTypes,logScale:()=>logScale,logScalePropTypes:()=>logScalePropTypes,pointScale:()=>pointScale,pointScalePropTypes:()=>pointScalePropTypes,scalePropType:()=>scalePropType,stackAxis:()=>stackAxis,stackX:()=>stackX,stackY:()=>stackY,timeScale:()=>timeScale,timeScalePropTypes:()=>timeScalePropTypes});let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},0);let scaleLinear,scaleLog,scalePoint,scaleUtc,scaleTime;module.link('d3-scale',{scaleLinear(v){scaleLinear=v},scaleLog(v){scaleLog=v},scalePoint(v){scalePoint=v},scaleUtc(v){scaleUtc=v},scaleTime(v){scaleTime=v}},1);let utcParse,timeParse;module.link('d3-time-format',{utcParse(v){utcParse=v},timeParse(v){timeParse=v}},2);let uniq;module.link('lodash/uniq',{default(v){uniq=v}},3);let uniqBy;module.link('lodash/uniqBy',{default(v){uniqBy=v}},4);let sortBy;module.link('lodash/sortBy',{default(v){sortBy=v}},5);let last;module.link('lodash/last',{default(v){last=v}},6);let isDate;module.link('lodash/isDate',{default(v){isDate=v}},7);
