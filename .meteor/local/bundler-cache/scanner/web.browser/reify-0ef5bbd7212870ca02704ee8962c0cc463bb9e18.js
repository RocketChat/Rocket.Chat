module.export({Axes:()=>Axes,Axis:()=>memoizedAxis,AxisTick:()=>memoizedAxisTick,Grid:()=>Grid,GridLine:()=>GridLine,GridLines:()=>GridLines,axisPropType:()=>axisPropType,axisPropTypes:()=>axisPropTypes,positions:()=>positions,renderAxesToCanvas:()=>renderAxesToCanvas,renderAxisToCanvas:()=>renderAxisToCanvas,renderGridLinesToCanvas:()=>renderGridLinesToCanvas});let memo,useMemo,createElement;module.link('react',{memo(v){memo=v},useMemo(v){useMemo=v},createElement(v){createElement=v}},0);let animated,useSpring,useTransition;module.link('@react-spring/web',{animated(v){animated=v},useSpring(v){useSpring=v},useTransition(v){useTransition=v}},1);let textPropsByEngine,useTheme,useMotionConfig,degreesToRadians;module.link('@nivo/core',{textPropsByEngine(v){textPropsByEngine=v},useTheme(v){useTheme=v},useMotionConfig(v){useMotionConfig=v},degreesToRadians(v){degreesToRadians=v}},2);let timeInterval,timeMillisecond,utcMillisecond,timeSecond,utcSecond,timeMinute,utcMinute,timeHour,utcHour,timeWeek,utcWeek,timeSunday,utcSunday,timeMonday,utcMonday,timeTuesday,utcTuesday,timeWednesday,utcWednesday,timeThursday,utcThursday,timeFriday,utcFriday,timeSaturday,utcSaturday,timeMonth,utcMonth,timeYear,utcYear;module.link('d3-time',{timeInterval(v){timeInterval=v},timeMillisecond(v){timeMillisecond=v},utcMillisecond(v){utcMillisecond=v},timeSecond(v){timeSecond=v},utcSecond(v){utcSecond=v},timeMinute(v){timeMinute=v},utcMinute(v){utcMinute=v},timeHour(v){timeHour=v},utcHour(v){utcHour=v},timeWeek(v){timeWeek=v},utcWeek(v){utcWeek=v},timeSunday(v){timeSunday=v},utcSunday(v){utcSunday=v},timeMonday(v){timeMonday=v},utcMonday(v){utcMonday=v},timeTuesday(v){timeTuesday=v},utcTuesday(v){utcTuesday=v},timeWednesday(v){timeWednesday=v},utcWednesday(v){utcWednesday=v},timeThursday(v){timeThursday=v},utcThursday(v){utcThursday=v},timeFriday(v){timeFriday=v},utcFriday(v){utcFriday=v},timeSaturday(v){timeSaturday=v},utcSaturday(v){utcSaturday=v},timeMonth(v){timeMonth=v},utcMonth(v){utcMonth=v},timeYear(v){timeYear=v},utcYear(v){utcYear=v}},3);let timeFormat;module.link('d3-time-format',{timeFormat(v){timeFormat=v}},4);let format;module.link('d3-format',{format(v){format=v}},5);let jsxs,jsx,Fragment;module.link('react/jsx-runtime',{jsxs(v){jsxs=v},jsx(v){jsx=v},Fragment(v){Fragment=v}},6);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},7);
