...
var AdminInfoForm = function (_a) {
    ...
    var companyEmailField = useUniqueId();
    ...
    return (_jsxs(Form, __assign({ onSubmit: handleSubmit(onSubmit) }, { children: [_jsx(Form.Steps, { currentStep: currentStep, stepCount: stepCount }, void 0), _jsx(Form.Title, { children: t('form.adminInfoForm.title') }, void 0), _jsx(Form.Subtitle, { children: t('form.adminInfoForm.subtitle') }, void 0), _jsx(Form.Container, { children: _jsxs(FieldGroup, { children: [_jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: fullnameField }, { children: t('form.adminInfoForm.fields.fullName.placeholder') }), void 0), _jsx(Field.Row, { children: _jsx(TextInput, __assign({}, register('fullname', {
                                    ...
                                    }), { placeholder: t('form.adminInfoForm.fields.username.placeholder'), id: usernameField }), void 0) }, void 0), errors.username && (_jsx(Field.Error, { children: errors.username.message }, void 0))] }, void 0), _jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: companyEmailField }, { children: t('form.adminInfoForm.fields.companyEmail.label') }), void 0), _jsx(Field.Row, { children: _jsx(EmailInput, __assign({}, register('companyEmail', {
                                        required: String(t('component.form.requiredField')),
                                        validate: validateEmail,
                                    }), { placeholder: t('form.adminInfoForm.fields.companyEmail.placeholder'), id: companyEmailField }), void 0) }, void 0), errors.companyEmail && (_jsx(Field.Error, { children: errors.companyEmail.message }, void 0))] }, void 0), _jsxs(Field, { children: [_jsx(Field.Label, __assign({ htmlFor: passwordField }, { children: t('form.adminInfoForm.fields.password.label') }), void 0), _jsx(Field.Row, { children: _jsx(PasswordInput, __assign({}, register('password', {
                                        required: String(t('component.form.requiredField')),
