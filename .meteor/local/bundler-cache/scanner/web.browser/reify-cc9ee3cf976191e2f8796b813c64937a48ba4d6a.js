module.export({parseHtml:()=>parseHtml});let __assign;module.link("tslib",{__assign(v){__assign=v}},0);let letterRe,digitRe,whitespaceRe,quoteRe,controlCharsRe;module.link('../regex-lib',{letterRe(v){letterRe=v},digitRe(v){digitRe=v},whitespaceRe(v){whitespaceRe=v},quoteRe(v){quoteRe=v},controlCharsRe(v){controlCharsRe=v}},1);let throwUnhandledCaseError;module.link('../utils',{throwUnhandledCaseError(v){throwUnhandledCaseError=v}},2);
