module.export({ANCHOR_BOTTOM:()=>ANCHOR_BOTTOM,ANCHOR_BOTTOM_LEFT:()=>ANCHOR_BOTTOM_LEFT,ANCHOR_BOTTOM_RIGHT:()=>ANCHOR_BOTTOM_RIGHT,ANCHOR_CENTER:()=>ANCHOR_CENTER,ANCHOR_LEFT:()=>ANCHOR_LEFT,ANCHOR_RIGHT:()=>ANCHOR_RIGHT,ANCHOR_TOP:()=>ANCHOR_TOP,ANCHOR_TOP_LEFT:()=>ANCHOR_TOP_LEFT,ANCHOR_TOP_RIGHT:()=>ANCHOR_TOP_RIGHT,BoxLegendSvg:()=>BoxLegendSvg,DIRECTION_BOTTOM_TO_TOP:()=>DIRECTION_BOTTOM_TO_TOP,DIRECTION_COLUMN:()=>DIRECTION_COLUMN,DIRECTION_LEFT_TO_RIGHT:()=>DIRECTION_LEFT_TO_RIGHT,DIRECTION_RIGHT_TO_LEFT:()=>DIRECTION_RIGHT_TO_LEFT,DIRECTION_ROW:()=>DIRECTION_ROW,DIRECTION_TOP_TO_BOTTOM:()=>DIRECTION_TOP_TO_BOTTOM,LegendPropShape:()=>LegendPropShape,LegendSvg:()=>LegendSvg,LegendSvgItem:()=>LegendSvgItem,datumPropType:()=>datumPropType,interactivityPropTypes:()=>interactivityPropTypes,legendEffectPropType:()=>legendEffectPropType,renderLegendToCanvas:()=>renderLegendToCanvas,symbolPropTypes:()=>symbolPropTypes,useQuantizeColorScaleLegendData:()=>useQuantizeColorScaleLegendData});let React,PureComponent,useState,useCallback,useMemo;module.link('react',{default(v){React=v},PureComponent(v){PureComponent=v},useState(v){useState=v},useCallback(v){useCallback=v},useMemo(v){useMemo=v}},0);let PropTypes;module.link('prop-types',{default(v){PropTypes=v}},1);let isFunction;module.link('lodash/isFunction',{default(v){isFunction=v}},2);let useTheme;module.link('@nivo/core',{useTheme(v){useTheme=v}},3);let isNumber;module.link('lodash/isNumber',{default(v){isNumber=v}},4);let isPlainObject;module.link('lodash/isPlainObject',{default(v){isPlainObject=v}},5);
