module.export({InviteUserAgentServer:()=>InviteUserAgentServer});let Dialog,SessionDialog;module.link("../dialogs",{Dialog(v){Dialog=v},SessionDialog(v){SessionDialog=v}},0);let TransactionStateError;module.link("../exceptions",{TransactionStateError(v){TransactionStateError=v}},1);let SignalingState;module.link("../session",{SignalingState(v){SignalingState=v}},2);let InviteServerTransaction;module.link("../transactions",{InviteServerTransaction(v){InviteServerTransaction=v}},3);let AllowedMethods;module.link("../user-agent-core/allowed-methods",{AllowedMethods(v){AllowedMethods=v}},4);let UserAgentServer;module.link("./user-agent-server",{UserAgentServer(v){UserAgentServer=v}},5);
