...
var InvalidLinkPage = function (_a) {
    ...
    return (_jsx(BackgroundLayer, { children: _jsx(Box, __assign({ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', width: '100%', maxWidth: 576, paddingBlock: 32, paddingInline: 16 }, { children: _jsxs(Margins, __assign({ blockEnd: 32 }, { children: [_jsx(OnboardingLogo, {}, void 0), _jsx(Box, __assign({ fontScale: 'hero' }, { children: t('page.invalidLink.title') }), void 0), _jsx(Box, __assign({ fontScale: 'p1' }, { children: t('page.invalidLink.content') }), void 0), _jsx(Button, __assign({ onClick: onRequestNewLink, primary: true }, { children: t('page.invalidLink.button.text') }), void 0)] }), void 0) }), void 0) }, void 0));
};
module.exportDefault(InvalidLinkPage);
