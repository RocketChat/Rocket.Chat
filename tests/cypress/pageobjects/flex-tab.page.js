...
class FlexTab extends Page {
	...
	get channelTab() {
		return browser.element(
			'.tab-button:not(.hidden) .tab-button-icon--info-circled',
		);
	}
	...
	get membersTab() {
		return browser.element(
			'.tab-button:not(.hidden) .tab-button-icon--team',
		);
	}
	...
	get searchTab() {
		return browser.element(
			'.tab-button:not(.hidden) .tab-button-icon--magnifier',
		);
	}
	...
	get fileDelete() {
		return browser.element(
			'.uploaded-files-list ul:first-child .file-delete',
		);
	}

	get fileDownload() {
		return browser.element(
			'.uploaded-files-list ul:first-child .file-download',
		);
	}

	get fileName() {
		return browser.element(
			'.uploaded-files-list ul:first-child .room-file-item',
		);
	}
	...
	get mentionsTab() {
		return browser.element(
			'.rc-popover__item[data-id=mentions], .tab-button[data-id=mentions]',
		);
	}
	...
	get usersSendInvitationTab() {
		return browser.element(
			'.tab-button:not(.hidden) .tab-button-icon--send',
		);
	}

	get usersAddUserTab() {
		return browser.element(
			'.tab-button:not(.hidden) .tab-button-icon--plus',
		);
	}
