...
describe('[Rooms]', function() {
	...
	describe('[/rooms.fullInfo]', () => {
		it('should return an object with "update" and "remove" properties and it should be an array', (done) => {
			request.get(api('rooms.fullInfo'))
				.set(credentials)
				.expect(200)
				.expect((res) => {
					expect(res.body).to.have.property('success', true);
		...
		it('should return an object with "update" and "remove" properties and it should be an array when I send "updatedSince" query parameter', (done) => {
			request.get(api('rooms.fullInfo'))
				.set(credentials)
				.query({
					updatedSince: new Date,
