...
export const createPermissions = async (): Promise<void> => {
	...
	await Promise.all([
		Permissions.create('manage-livechat-units', [
			adminRole,
			livechatManagerRole,
		]),
		Permissions.create('manage-livechat-monitors', [
			adminRole,
			livechatManagerRole,
		]),
		Permissions.create('manage-livechat-tags', [
			adminRole,
			livechatManagerRole,
		]),
		Permissions.create('manage-livechat-priorities', [
			adminRole,
			livechatManagerRole,
		]),
