...
- ([#38124](https://github.com/RocketChat/Rocket.Chat/pull/38124) by [@dionisio-bot](https://github.com/dionisio-bot)) Fixes an issue where some DDP streamer requests were returning before processing was completed
