...
} from '../../../../../../src/application/room/input/RoomSenderDto';
import { FederationRoomSenderConverter } from '../../../../../../src/infrastructure/rocket-chat/converters/RoomSender';

describe('Federation - Infrastructure - Matrix - FederationRoomSenderConverter', () => {
	...
	describe('#toRoomInviteUserDto()', () => {
		it('should return an instance of FederationRoomInviteUserDto', () => {
			expect(FederationRoomSenderConverter.toRoomInviteUserDto('inviterId', 'roomId', inviteeId)).to.be.instanceOf(
				FederationRoomInviteUserDto,
			);
		});
		...
		it('should return the basic user  properties correctly (normalizedInviteeId without any "@" and inviteeUsernameOnly only the part before the ":") if any', () => {
			const result = FederationRoomSenderConverter.toRoomInviteUserDto('inviterId', 'roomId', inviteeId);
	...
	describe('#toSetupRoomDto()', () => {
		it('should return an instance of FederationSetupRoomDto', () => {
			expect(FederationRoomSenderConverter.toSetupRoomDto('inviterId', 'roomId')).to.be.instanceOf(FederationSetupRoomDto);
		});

		it('should return the invitees without the owner and with normalized invitees', () => {
			const result = FederationRoomSenderConverter.toSetupRoomDto('inviterId', 'roomId');
	...
	describe('#toOnRoomCreationDto()', () => {
		it('should return an instance of FederationRoomInviteUserDto', () => {
			expect(
				FederationRoomSenderConverter.toOnRoomCreationDto('inviterId', 'username', 'roomId', ['username1'], 'domain'),
			).to.be.instanceOf(FederationOnRoomCreationDto);
		});

		it('should return the invitees without the owner and with normalized invitees', () => {
			const result = FederationRoomSenderConverter.toOnRoomCreationDto(
				'inviterId',
				'username',
				'roomId',
				[inviteeId, 'username'],
	...
	describe('#toOnAddedUsersToARoomDto()', () => {
		it('should return the invitees without the owner and with normalized invitees', () => {
			const result = FederationRoomSenderConverter.toOnAddedUsersToARoomDto(
				'inviterId',
				'username',
				'roomId',
				[inviteeId, 'username'],
	...
	describe('#toOnDirectMessageCreatedDto()', () => {
		it('should return the invitees without the owner and with normalized invitees', () => {
			const result = FederationRoomSenderConverter.toOnDirectMessageCreatedDto(
				'inviterId',
				'roomId',
	...
	describe('#toBeforeDirectMessageCreatedDto()', () => {
		it('should return the invitees without the owner and with normalized invitees', () => {
			const result = FederationRoomSenderConverter.toBeforeDirectMessageCreatedDto(
				[inviteeId, { _id: 'inviterId', username: 'username' } as any, { _id: '_id', username: 'usernameToBeInvited' } as any],
				'domain',
			);
	...
	describe('#toBeforeAddUserToARoomDto()', () => {
		it('should return the invitees correctly', () => {
			const result = FederationRoomSenderConverter.toBeforeAddUserToARoomDto(
				[inviteeId, { _id: 'inviterId', username: 'username' } as any, { _id: '_id', username: 'usernameToBeInvited' } as any],
				{ _id: 'roomId' } as any,
				'domain',
			);
	...
	describe('#toCreateDirectMessageDto()', () => {
		it('should return the invitees correctly', () => {
			const result = FederationRoomSenderConverter.toCreateDirectMessageDto('inviterId', [
				inviteeId,
	...
	describe('#toJoinExternalPublicRoomDto()', () => {
		it('should return the basic room properties correctly (normalizedRoomId without any "!" and only the part before the ":") if any', () => {
			const result = FederationRoomSenderConverter.toJoinExternalPublicRoomDto('internalUserId', '!externalRoomId:server.com');
