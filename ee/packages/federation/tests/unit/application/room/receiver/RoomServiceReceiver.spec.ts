...
import { EVENT_ORIGIN } from '../../../../../src/domain/IFederationBridge';

const { FederationRoomServiceReceiver } = proxyquire.noCallThru().load('../../../../../src/application/room/receiver/RoomServiceReceiver', {
	mongodb: {
...
const { FederatedUser } = proxyquire.noCallThru().load('../../../../../src/domain/FederatedUser', {
	mongodb: {
		'ObjectId': class ObjectId {
			toHexString(): string {
				return 'hexString';
...
const { DirectMessageFederatedRoom, FederatedRoom } = proxyquire.noCallThru().load('../../../../../src/domain/FederatedRoom', {
	mongodb: {
		'ObjectId': class ObjectId {
			toHexString(): string {
				return 'hexString';
