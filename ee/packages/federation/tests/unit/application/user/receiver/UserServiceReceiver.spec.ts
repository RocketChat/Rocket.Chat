...
const { FederationUserServiceReceiver } = proxyquire.noCallThru().load('../../../../../src/application/user/receiver/UserServiceReceiver', {
	mongodb: {
...
describe('Federation - Application - FederationUserServiceReceiver', () => {
	let service: typeof FederationUserServiceReceiver;
	const roomAdapter = {
	...
	beforeEach(() => {
		service = new FederationUserServiceReceiver(
			roomAdapter as any,
			userAdapter as any,
			fileAdapter as any,
