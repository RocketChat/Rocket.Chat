...
const { FederationUserService } = proxyquire.noCallThru().load('../../../../src/application/user/UserService', {
	mongodb: {
...
describe('Federation - Application - FederationUserService', () => {
	let service: typeof FederationUserService;
	const roomAdapter = {
	...
	beforeEach(() => {
		service = new FederationUserService(settingsAdapter as any, fileAdapter as any, userAdapter as any, bridge as any);
	});
