...
import { MediaCalls, MediaCallNegotiations, VideoConference as VideoConferenceModel } from '@rocket.chat/models';
...
export abstract class BaseSipCall extends BaseCallProvider {
	 ...
	 * If the contact information is different from the previous invite, update the contact details on the call.
	 */
