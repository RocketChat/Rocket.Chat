...
API.v1.addRoute(
	...
	},
	{
		async get() {
			...
			const data = await findWeeklyUsersRegisteredData(
...
API.v1.addRoute(
	...
	},
	{
		async get() {
			...
			const data = await findActiveUsersMonthlyData(
				transformDatesForAPI(start, end),
			);
			return API.v1.success(data);
		},
...
API.v1.addRoute(
	...
	},
	{
		async get() {
			...
			const data = await findBusiestsChatsInADayByHours(
				transformDatesForAPI(start),
			);
			return API.v1.success(data);
		},
	},
...
API.v1.addRoute(
	...
	},
	{
		async get() {
			...
			const data = await findBusiestsChatsWithinAWeek(
				transformDatesForAPI(start),
			);
			return API.v1.success(data);
		},
...
API.v1.addRoute(
	...
	},
	{
		async get() {
			...
			const data = await findUserSessionsByHourWithinAWeek(
				transformDatesForAPI(start, end),
			);
			return API.v1.success(data);
		},
