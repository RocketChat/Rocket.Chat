...
- "Add reaction" icon missing when the viewport size is smaller than 500px ([#18110](https://github.com/RocketChat/Rocket.Chat/pull/18110) by [@mariaeduardacunha](https://github.com/mariaeduardacunha))
