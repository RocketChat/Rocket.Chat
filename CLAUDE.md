...
- [docs/service-brokers.md](docs/service-brokers.md) — how services reach each other: the three brokers (local, Moleculer, NATS), what the new NATS one had to rebuild, and the calls that only work because both ends share a process
