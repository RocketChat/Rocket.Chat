...
Migrate seven client DDP callers to their new REST equivalents (DDP methods stay registered for external SDK/mobile clients with deprecation logs until 9.0.0):
...
- `getRoomByTypeAndName` → `GET /v1/rooms.getByTypeAndName`.
