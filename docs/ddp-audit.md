...
Generated: 2026-05-22T16:35:38.003Z

| metric | count |
|---|---|
| Registered methods | 186 |
| Used (has caller) | 77 |
| Orphans (no caller) | 109 |
| Used without REST replacement | 39 |
| REST routes scanned | 381 |

## 1. Used methods (77)

| method | registration | callers | REST replacement |
|---|---|---|---|
| `sendMessage` | apps/meteor/app/lib/server/methods/sendMessage.ts:135 | 8 | `chat.sendMessage` |
| `autoTranslate.translateMessage` | apps/meteor/app/autotranslate/server/methods/translateMessage.ts:15 | 2 | — none — |
...
| `getRoomByTypeAndName` | apps/meteor/server/publications/room/index.ts:53 | 1 | `rooms.info` |
...
| `rocketchatSearch.getProvider` | apps/meteor/app/search/server/methods.ts:26 | 1 | — none — |
| `rocketchatSearch.search` | apps/meteor/app/search/server/methods.ts:49 | 1 | — none — |
...
## 2. Orphan methods — no caller found (109)
...
| `addIncomingIntegration` | apps/meteor/app/integrations/server/methods/incoming/addIncomingIntegration.ts:180 |
...
| `updateIncomingIntegration` | apps/meteor/app/integrations/server/methods/incoming/updateIncomingIntegration.ts:190 |
...
## 3. Used methods without REST replacement (39)
...
| `autoTranslate.translateMessage` | apps/meteor/app/autotranslate/server/methods/translateMessage.ts:15 | 2 |
...
| `rocketchatSearch.getProvider` | apps/meteor/app/search/server/methods.ts:26 | 1 |
| `rocketchatSearch.search` | apps/meteor/app/search/server/methods.ts:49 | 1 |
