...
| `auth-providers/` | One folder/file per external login provider: `apple/`, `custom-oauth/`, `gitlab.ts`, `iframe.ts`. The Passport wiring they share lives in the `oauth/` domain. |
